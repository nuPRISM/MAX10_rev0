...
void HDMITX_Reset(void){
    ...
    IOWR(HDMI_SUBSYSTEM_HDMI_TX_RESET_N_BASE, 0, 1);
    usleep(20*1000);
    IOWR(HDMI_SUBSYSTEM_HDMI_TX_RESET_N_BASE, 0, 0);
    usleep(20*1000);
    IOWR(HDMI_SUBSYSTEM_HDMI_TX_RESET_N_BASE, 0, 1);
    usleep(20*1000);
}
...
void HDMIRX_Reset(void){
    ...
    IOWR(HDMI_SUBSYSTEM_HDMI_RX_RESET_N_BASE, 0, 1);
    usleep(20*1000);
    IOWR(HDMI_SUBSYSTEM_HDMI_RX_RESET_N_BASE, 0, 0);
    usleep(20*1000);
    IOWR(HDMI_SUBSYSTEM_HDMI_RX_RESET_N_BASE, 0, 1);
    usleep(20*1000);
}
...
BOOL ReadRXIntPin(void)
{
    ...
    if ((IORD(HDMI_SUBSYSTEM_HDMI_RX_IRQ_N_BASE, 0) & 0x01) == 0x00)
        bIrq = TRUE;
...
bool HDMIRX_EEPROM0_WriteI2C_Byte(alt_u8 RegAddr,alt_u8 Data){
    bool bSuccess;
    bSuccess = I2C_Write(HDMI_SUBSYSTEM_HDMI_RX0_EP_SCL_BASE, HDMI_SUBSYSTEM_HDMI_RX0_EP_SDA_BASE, EEPROM_DEVICE_ADDR, RegAddr, Data);
    return bSuccess;
}

bool HDMIRX_EEPROM1_WriteI2C_Byte(alt_u8 RegAddr,alt_u8 Data){
    bool bSuccess;
    bSuccess = I2C_Write(HDMI_SUBSYSTEM_HDMI_RX1_EP_SCL_BASE, HDMI_SUBSYSTEM_HDMI_RX1_EP_SDA_BASE, EEPROM_DEVICE_ADDR, RegAddr, Data);
    return bSuccess;
}

bool HDMIRX_EEPROM0_ReadI2C_Byte(alt_u8 RegAddr, alt_u8 *pData){
    bool bSuccess;
    bSuccess = I2C_Read(HDMI_SUBSYSTEM_HDMI_RX0_EP_SCL_BASE, HDMI_SUBSYSTEM_HDMI_RX0_EP_SDA_BASE, EEPROM_DEVICE_ADDR, RegAddr, pData);
    return bSuccess;    
}

bool HDMIRX_EEPROM1_ReadI2C_Byte(alt_u8 RegAddr, alt_u8 *pData){
    bool bSuccess;
    bSuccess = I2C_Read(HDMI_SUBSYSTEM_HDMI_RX1_EP_SCL_BASE, HDMI_SUBSYSTEM_HDMI_RX1_EP_SDA_BASE, EEPROM_DEVICE_ADDR, RegAddr, pData);
    return bSuccess;    
}
