/*
 * ltc6951_virtual_uart.h
 *
 *  Created on: Feb 7, 2014
 *      Author: yairlinn
 */

#ifndef LTC6951_VIRTUAL_UART_H_
#define LTC6951_VIRTUAL_UART_H_

#include "virtual_uart_register_file.h"
#include "ltc6951_driver.h"

class ltc6951_virtual_uart: public virtual_uart_register_file,
		public ltc6951_driver
{
protected:
  register_desc_map_type default_register_descriptions;

public:
	ltc6951_virtual_uart(unsigned long chipselect, unsigned long id_no);
