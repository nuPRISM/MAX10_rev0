...
extern "C" {
	extern void bedrock_dtrap(const char * file, const char * func, int line);
}
#ifndef TINYFORMAT_ERROR
//#   define TINYFORMAT_ERROR(reason) assert(0 && reason)
#define TINYFORMAT_ERROR(reason) do { safe_print(std::cout << "\nTinyFormat Error; Reason = " << reason << "\n"; bedrock_dtrap(__FILE__, __FUNCTION__, __LINE__));  } while (0)
#endif
...
{
    format(safe_print(std::cout, fmt, args...));
}
