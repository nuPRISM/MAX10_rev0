/*
 * ltc2263_virtual_uart.h
 *
 *  Created on: Feb 7, 2014
 *      Author: yairlinn
 */

#ifndef LTC2263_VIRTUAL_UART_H_
#define LTC2263_VIRTUAL_UART_H_

#include "virtual_uart_register_file.h"
#include "ltc2263_driver.h"

class ltc2263_virtual_uart: public virtual_uart_register_file,
		public ltc2263_driver
{
protected:
  register_desc_map_type default_register_descriptions;

public:
	ltc2263_virtual_uart();
