/*
 * ltc2263_virtual_uart.cpp
 *
 *  Created on: Feb 7, 2014
 *      Author: yairlinn
 */

#include "ltc2263_virtual_uart.h"
#include "basedef.h"
#include <sstream>
#include <iostream>
#include <string>
...
unsigned long long ltc2263_virtual_uart::read_control_reg(unsigned long address,
		...
		int* errorptr)
{
	 if (!is_valid_secondary_uart(secondary_uart_address)) {
		...
		return this->ltc2263_read(address);
};

void ltc2263_virtual_uart::write_control_reg(unsigned long address,
		...
		int* errorptr)
{
	...
	this->ltc2263_write(address,data);
};



ltc2263_virtual_uart::ltc2263_virtual_uart() :
