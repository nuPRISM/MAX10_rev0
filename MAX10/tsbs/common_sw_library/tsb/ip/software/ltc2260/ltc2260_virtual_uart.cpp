/*
 * ltc2260_virtual_uart.cpp
 *
 *  Created on: Feb 7, 2014
 *      Author: yairlinn
 */

#include "ltc2260_virtual_uart.h"
#include "basedef.h"
#include <sstream>
#include <iostream>
#include <string>
...
unsigned long long ltc2260_virtual_uart::read_control_reg(unsigned long address,
		...
		int* errorptr)
{
	 if (!is_valid_secondary_uart(secondary_uart_address)) {
		...
		return this->ltc2260_read(address);
};

void ltc2260_virtual_uart::write_control_reg(unsigned long address,
		...
		int* errorptr)
{
	...
	this->ltc2260_write(address,data);
};



ltc2260_virtual_uart::ltc2260_virtual_uart() :
	...
	ltc2260_driver() {
		...
		default_register_descriptions[0x002] = "Timing"                                             ;
		default_register_descriptions[0x003] = "OutputMode"                                           ;
		default_register_descriptions[0x004] = "Dataformat"                                           ;
