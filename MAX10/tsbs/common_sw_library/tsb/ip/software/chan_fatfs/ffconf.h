...
#define _FS_TIMEOUT		65500     	/* Timeout period in unit of time ticks - we must maintain below 65535 because of type INT16U */
...
#define	_FS_SHARE	100	/* 0:Disable or >=1:Enable */
