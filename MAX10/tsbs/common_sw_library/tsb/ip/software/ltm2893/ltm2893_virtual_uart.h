/*
 * ltm2893_virtual_uart.h
 *
 *  Created on: Feb 7, 2014
 *      Author: yairlinn
 */

#ifndef LTM2893_VIRTUAL_UART_H_
#define LTM2893_VIRTUAL_UART_H_

#include "virtual_uart_register_file.h"
#include "ltm2893_driver.h"

class ltm2893_virtual_uart: public virtual_uart_register_file,
		public ltm2893_driver
{
protected:
  register_desc_map_type default_register_descriptions;

public:
	ltm2893_virtual_uart();
