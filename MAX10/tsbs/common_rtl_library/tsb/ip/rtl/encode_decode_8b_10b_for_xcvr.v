module encode_decode_8b_10b_for_xcvr
(
  tx_uncoded_data_in,
  tx_encoded_data_out,
  rx_encoded_data_in,
  ...
  input [numbits_datain-1:0] tx_uncoded_data_in;
  output reg [numbits_datain-1:0] rx_decoded_data_out;
  ...
  output [numbits_encoded-1:0] tx_encoded_data_out;
  input  [numbits_encoded-1:0] rx_encoded_data_in;
...
(
.reset(reset),
.data_in(tx_uncoded_data_in),
.data_out(tx_encoded_data_out),
.clk(frame_clk),
...
(
  ...
  .data_in                                   (rx_encoded_data_in                       ),
  .data_out                                  (rx_decoded_data_out                      ),
