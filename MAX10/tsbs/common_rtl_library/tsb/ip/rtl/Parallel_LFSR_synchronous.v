...
module Parallel_LFSR_synchronous
#(
...
begin
	...
	begin
			if (num_bits_ready_clk)
			begin
					if (dec_num_bits_ready)
					begin
...
begin
	 ...
	 begin
		  ...
		  shift_output_register : state <= finished; //clr_lfsr_width_counter; //get_next_LFSR_value;
