...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../altera_fft_ii_181/sim/auk_dspip_text_pkg.vhd"              -work fft_1k_altera_fft_ii_181
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../altera_fft_ii_181/sim/auk_dspip_math_pkg.vhd"              -work fft_1k_altera_fft_ii_181
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../altera_fft_ii_181/sim/auk_dspip_lib_pkg.vhd"               -work fft_1k_altera_fft_ii_181
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../altera_fft_ii_181/sim/auk_dspip_roundsat.vhd"              -work fft_1k_altera_fft_ii_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fft_ii_181/sim/fft_1k_altera_fft_ii_181_ozmhwxi.sv" -work fft_1k_altera_fft_ii_181
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/fft_1k.v"                                                                                   
fi
