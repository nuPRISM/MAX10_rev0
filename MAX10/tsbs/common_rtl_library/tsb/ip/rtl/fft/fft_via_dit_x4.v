...
(* keep = ENABLE_KEEPS, preserve = ENABLE_KEEPS *) complex_float float_bypass_data[numchannels];
...
(
  ...
  .outdata({fft_complex_avst_outdata.valid[stream_index],fft_complex_avst_outdata.sop[stream_index],fft_complex_avst_outdata.eop[stream_index]}),
...
always_ff @(posedge clk)
begin
/*      fft_complex_avst_outdata.data[0] <=  select_float_bypass? {float_bypass_data[0].float_imag,float_bypass_data[0].float_real} : {Xr.float_imag              ,Xr.float_real              };
      fft_complex_avst_outdata.data[1] <=  select_float_bypass? {float_bypass_data[1].float_imag,float_bypass_data[1].float_real}  : {Xr_plus_N_div_4.float_imag ,Xr_plus_N_div_4.float_real };
      fft_complex_avst_outdata.data[2] <=  select_float_bypass? {float_bypass_data[2].float_imag,float_bypass_data[2].float_real}    {Xr_plus_2N_div_4.float_imag,Xr_plus_2N_div_4.float_real};
      fft_complex_avst_outdata.data[3] <=  select_float_bypass? {float_bypass_data[3].float_imag,float_bypass_data[3].float_real} :  {Xr_plus_3N_div_4.float_imag,Xr_plus_3N_div_4.float_real};
*/
	  fft_complex_avst_outdata.data[0] <=  select_float_bypass ? {float_bypass_data[0].float_imag,float_bypass_data[0].float_real} : {Xr.float_imag              ,Xr.float_real              };
      fft_complex_avst_outdata.data[1] <= select_float_bypass ? {float_bypass_data[1].float_imag,float_bypass_data[1].float_real} : {Xr_plus_N_div_4.float_imag ,Xr_plus_N_div_4.float_real };
      fft_complex_avst_outdata.data[2] <= select_float_bypass ? {float_bypass_data[2].float_imag,float_bypass_data[2].float_real} : {Xr_plus_2N_div_4.float_imag,Xr_plus_2N_div_4.float_real};
