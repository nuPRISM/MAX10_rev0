...
module opencores_spi_standalone_altera_merlin_router_181_dj5fney_default_decode
  #(
...
module opencores_spi_standalone_altera_merlin_router_181_dj5fney
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    opencores_spi_standalone_altera_merlin_router_181_dj5fney_default_decode the_default_decode(
    ...
    // ( 0x90 .. 0xa0 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 8'h90   ) begin
            src_channel = 7'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0xa0 .. 0xb0 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 8'ha0  && read_transaction  ) begin
