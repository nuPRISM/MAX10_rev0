...
module opencores_spi_standalone_mm_interconnect_0_router_default_decode
  #(
...
module opencores_spi_standalone_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    opencores_spi_standalone_mm_interconnect_0_router_default_decode the_default_decode(
