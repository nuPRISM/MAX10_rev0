// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/rainier/ARAMB36_INTERNAL.v,v 1.13.2.7 2007/04/04 00:25:43 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
// xilinx_internal_parameter off
    ...
    integer count1, countp1, i, i1, i_p;
...
/************************************* Collision starts *****************************************/
	  ...
	  if (SIM_COLLISION_CHECK != "NONE") begin
		...
		if (viol_time != 0) begin
			...
			if (addra_in[14:col_addr_lsb] === addrb_in[14:col_addr_lsb]) begin
			...
			if (addra_in[14:col_addr_lsb] === addrb_reg[14:col_addr_lsb]) begin
			...
			if (addra_reg[14:col_addr_lsb] === addrb_in[14:col_addr_lsb]) begin
