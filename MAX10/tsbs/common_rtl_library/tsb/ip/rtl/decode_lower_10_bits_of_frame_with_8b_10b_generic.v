module decode_lower_10_bits_of_frame_with_8b_10b_generic 
#(
...
output reg [output_frame_length-1:0] pipeline_delay_of_uncoded_bits,
...
always @(posedge clk)
begin
     pipeline_delay_of_uncoded_bits <= (data_in >> 10); //to match delay of 8b_10b encoder
end
