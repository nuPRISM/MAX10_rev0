...
module generic_jesd_adc_support_w_spiral_fft
#(
...
parameter COMPILE_FFT_W_UART = 1,
...
parameter math_func_package::FFT_IMPLEMENTATION_METHOD_ENUM_TYPE FFT_IMPLEMENTATION_METHOD[NUM_OF_DATA_STREAMS],
parameter DEFAULT_ACTUAL_NUM_OF_DATA_VALUES_TO_ACQUIRE = math_func_package::get_num_of_fft_samples(FFT_IMPLEMENTATION_METHOD[0])
)
(
...
generate
		if (COMPILE_FFT_W_UART)
		begin
				fft_4096_32bit_avst_w_uart
				#(
				...
				.fft_output_bits_per_component                       (32),
				...
				.ASSIGN_AVST_OUTDATA_CLK(1),
				.FFT_IMPLEMENTATION_METHOD(FFT_IMPLEMENTATION_METHOD)
				)
				fft_4096_32bit_avst_w_uart_inst
				(    
