...
module hw_dma_to_descriptors_via_state_machine_w_separate_masters
#(
...
transfer_word_over_separate_avalon_mm_interfaces 
#(
	.DATAWIDTH      (DATAWIDTH),
...
transfer_word_over_avalon_mm_inst (
	...
	.master_waitrequest_read(master_waitrequest_read),
	.master_waitrequest_write(master_waitrequest_write),
