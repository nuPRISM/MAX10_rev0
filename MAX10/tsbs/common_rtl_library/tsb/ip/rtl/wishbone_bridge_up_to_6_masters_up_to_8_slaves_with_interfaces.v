...
`endif
 ...
 module wishbone_bridge_up_to_6_masters_up_to_8_slaves_with_interfaces
 #(
 parameter WATCHDOG_TIMER_WIDTH = 16,
  ...
  SLAVE5_SEL_ADDRESS = 32'hFFFFFFFF,   
  SLAVE6_SEL_ADDRESS = 32'hFFFFFFFF,   
  SLAVE7_SEL_ADDRESS = 32'hFFFFFFFF,   
