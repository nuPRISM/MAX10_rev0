...
module arria_v_strandalone_serialite_priority_xcvr_1_channel_w_uart_control
#(
...
(* keep = 1 *)  wire [31:0] slite_status = {
  ...
  1'b0,xcvr_reconfig_busy,rxhpp_dav,txhpp_dav, 
  stat_rr_gxsync [3:0],
  stat_rr_pattdet [3:0],
...
begin
 ...
 (* keep = 1 *) wire           reconfig_reset;
 	(* keep = 1 *) 	wire busy;
 	(* keep = 1 *) 	wire tx_cal_busy;
	(* keep = 1 *) 	wire rx_cal_busy;	
	
seriallite_arria_v_quartus_14_1
...
parameter slit_phy_and_reconfig_num_of_local_regfile_control_regs     =  32'h280; //number of words in the address space
...
wire auto_reset, auto_reset_clk_125;
...
assign phy_and_reconfig_uart_interface_pins.user_type            = uart_regfile_types::ARRIA_V_XCVR_PHY_CTRL_REGFILE;
...
assign slite_phy_and_reconfig_uart_tx                            = phy_and_reconfig_uart_interface_pins.txd;
	   ...
	   avalon_mm_simple_bridge_interface 
	    ...
	    arria_v_seriallite_xcvr_standalone_phy 
        arria_v_seriallite_xcvr_standalone_phy_inst		(
        .clk_125_mhz_clk                                         (CLKIN_125MHz                                                                          ),                                         //                  clk_125_mhz.clk
        .reset_for_clk_125_mhz_reset_n                           (!RESET_FOR_CLKIN_125MHz  & !auto_reset_clk_125                          ),                                           //                        reset.reset_n
        .avalon_slave_address                                    ({phy_and_reconfig_avalon_mm_control_interface_pins.address,2'b00} /*shift up address by 2 */                                ),                                    //                 avalon_slave.address
        ...
        .avalon_bridge_reset_50_mhz_reset_n                      (!RESET_FOR_CLKIN_50MHz  & !auto_reset   ),                      //   avalon_bridge_reset_50_mhz.reset_n
		...
		.new_arria_v_reconfig_for_quartus_14_1_one_chan_0_tx_cal_busy_tx_cal_busy               (tx_cal_busy),               //                  new_arria_v_reconfig_for_quartus_14_1_one_chan_0_tx_cal_busy.tx_cal_busy
        .new_arria_v_reconfig_for_quartus_14_1_one_chan_0_reconfig_busy_reconfig_busy           (xcvr_reconfig_busy),           //                new_arria_v_reconfig_for_quartus_14_1_one_chan_0_reconfig_busy.reconfig_busy
        .new_arria_v_reconfig_for_quartus_14_1_one_chan_0_rx_cal_busy_rx_cal_busy               (rx_cal_busy),               //                  new_arria_v_reconfig_for_quartus_14_1_one_chan_0_rx_cal_busy.rx_cal_busy
        .new_arria_v_reconfig_for_quartus_14_1_one_chan_0_reconfig_from_xcvr_reconfig_from_xcvr (reconfig_from_xcvr), //           new_arria_v_reconfig_for_quartus_14_1_one_chan_0_reconfig_from_xcvr.reconfig_from_xcvr
        .new_arria_v_reconfig_for_quartus_14_1_one_chan_0_reconfig_to_xcvr_reconfig_to_xcvr     (reconfig_to_xcvr),     //             new_arria_v_reconfig_for_quartus_14_1_one_chan_0_reconfig_to_xcvr.reconfig_to_xcvr
        .arriav_custom_seriallite_ii_phy_for_quartus_13_1_wrapper_0_reconfig_to_xcvr_export     (reconfig_to_xcvr),     //   arriav_custom_seriallite_ii_phy_for_quartus_13_1_wrapper_0_reconfig_to_xcvr.export
        .arriav_custom_seriallite_ii_phy_for_quartus_13_1_wrapper_0_reconfig_from_xcvr_export   (reconfig_from_xcvr)    // arriav_custom_seriallite_ii_phy_for_quartus_13_1_wrapper_0_reconfig_from_xcvr.export
