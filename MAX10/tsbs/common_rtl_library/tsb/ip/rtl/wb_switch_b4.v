...
`define WB_SWITCH_B3_USE_KEEP_AND_PRESERVE (* keep = 1 , preserve = 1 *)
`ifdef NUM_MASTERS_6
...
`endif
   ...
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs0_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs0_master_sel_new;
`ifdef WBS1
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs1_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs1_master_sel_new;
`endif
`ifdef WBS2
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs2_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs2_master_sel_new;
`endif
`ifdef WBS3
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs3_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs3_master_sel_new;   
`endif
`ifdef WBS4
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs4_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs4_master_sel_new;   
`endif
`ifdef WBS5
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs5_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs5_master_sel_new;   
`endif
`ifdef WBS6
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs6_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs6_master_sel_new;   
`endif
`ifdef WBS7
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_MASTERS-1:0] wbs7_master_sel;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbs7_master_sel_new;   
`endif

   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_SLAVES-1:0]  wbm0_slave_sel;
`ifdef WBM1   
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_SLAVES-1:0]  wbm1_slave_sel;
`endif
`ifdef WBM2
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_SLAVES-1:0]  wbm2_slave_sel;
`endif
`ifdef WBM3   
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_SLAVES-1:0]  wbm3_slave_sel;
`endif
`ifdef WBM4
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_SLAVES-1:0]  wbm4_slave_sel;
`endif
`ifdef WBM5
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire [`NUM_SLAVES-1:0]  wbm5_slave_sel;
`endif
   ...
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel0
     (
      // Outputs
...
`ifdef WBS1
   ...
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel1
     (
      // Outputs
...
`ifdef WBS2
   // Slave selec logic, for each master   
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel2
     (
      // Outputs
...
`ifdef WBS3
   // Slave selec logic, for each master   
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel3
     (
      // Outputs
...
`ifdef WBS4
   // Slave selec logic, for each master   
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel4
     (
      // Outputs
...
`ifdef WBS5
   // Slave selec logic, for each master   
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel5
     (
      // Outputs
...
`ifdef WBS6
   // Slave selec logic, for each master   
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel6
     (
      // Outputs
...
`ifdef WBS7
   // Slave selec logic, for each master   
   wb_b3_switch_slave_sel #(.dw(dw),.aw(aw))  slave_sel7
     (
      // Outputs
...
`endif //  `ifdef WBM5
   ...
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave0_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux0
     (
      // Outputs
...
`ifdef WBS1
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave1_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux1
     (
      // Outputs
...
`ifdef WBS2
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave2_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux2
     (
      // Outputs
...
`ifdef WBS3
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave3_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux3
     (
      // Outputs
...
`endif //  `ifdef WBS3
`ifdef WBS4
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw), .slave_sel_bit_width(slave4_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux4
     (
      // Outputs
...
`endif //  `ifdef WBS4
`ifdef WBS5
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw), .slave_sel_bit_width(slave5_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux5
     (
      // Outputs
...
`endif //  `ifdef WBS5
`ifdef WBS6
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave6_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux6
     (
      // Outputs
...
`endif //  `ifdef WBS6
`ifdef WBS7
   wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave7_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux7
     (
      // Outputs
...
`endif
   ...
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE  output reg [num_masters - 1:0] wbs_master_sel;
   output 			  wbs_master_sel_new;

   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg [num_masters - 1:0] 	  wbs_master_sel_r;

   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg [num_masters - 1:0] 	  last_master;

   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 			  wbm0_req;
	// REMOVE DEBUG CODE
/*
...
module wb_b3_switch_master_detect_slave_sel
  (   
    `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE  output reg [`NUM_SLAVES-1:0] wbm_slave_sel,
...
`ifdef WATCHDOG_TIMER   
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg [watchdog_timer_width-1:0] watchdog_timer;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg 			   watchdog_err;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg 			   wbm_stb_r, wbm_stb_r2; // Register strobe
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   wbm_stb_edge; // Detect its edge
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg 			   wbm_stb_edge_r;
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE reg 			   wbm_ack_i_r;
...
`else
   `WB_SWITCH_B3_USE_KEEP_AND_PRESERVE wire 		   watchdog_err;
