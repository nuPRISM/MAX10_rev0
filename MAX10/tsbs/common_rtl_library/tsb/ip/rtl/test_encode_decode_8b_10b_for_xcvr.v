module test_encode_decode_8b_10b_for_xcvr
(
  frame_clk,
  reset,
  frame_select,
...
(
  ...
  .tx_uncoded_data_in(data_in),
  .tx_encoded_data_out(encoder_data_out),
  .rx_encoded_data_in(selected_encoder_data_out),
  .rx_decoded_data_out(data_out),
