...
module integrate_and_hold_ivc102
#(
...
parameter start_pre_int_adc_conversion     = 16'b0000_1110_0000_0110;
...
parameter set_reset_inactive_now_end       = 16'b0001_0010_0000_1111;
parameter set_reset_active_now_end         = 16'b0000_0011_0001_0000;
parameter finished                         = 16'b0100_0010_0001_0001;
...
begin
	 ...
	 begin
		  ...
		  idle : if (start)
           ...
           stop_integration        : state <= start_hold_wait;
           ...
           wait_for_adc_conversion : if (post_conversion)
		                             begin
											       if (keep_reset_active_after_integration)
...
begin
	 ...
	 if (latch_pre_integration_data_now)
	 begin
