...
module choose_between_two_avalon_st_interfaces
#(
...
begin
       ...
       avalon_st_interface_out.sop   = actual_sel ? avalon_st_interface_in1.sop       : avalon_st_interface_in0.sop;
       avalon_st_interface_out.eop   = actual_sel ? avalon_st_interface_in1.eop       : avalon_st_interface_in0.eop;
       avalon_st_interface_out.empty = actual_sel ? avalon_st_interface_in1.empty     : avalon_st_interface_in0.empty;
       avalon_st_interface_out.error = actual_sel ? avalon_st_interface_in1.error     : avalon_st_interface_in0.error;
end
