module encode_lower_bits_of_frame_with_8b_10b_generic 
#(
...
reg [input_frame_length-1:0] pipeline_match_data_delay1, pipeline_match_data_delay2;

always @(posedge clk)
begin
     pipeline_match_data_delay1 <= (data_in >> 8);
