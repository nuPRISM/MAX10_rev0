...
// Generated on Wed Jul 24 14:38:07 EDT 2019
...
// latency=998, gap=1024
   rc86546 stage0(.clk(clk), .reset(reset), .next(next_0), .next_out(next_1),
    .X0(t0_0), .Y0(t1_0),
    .X1(t0_1), .Y1(t1_1),
    .X2(t0_2), .Y2(t1_2),
    .X3(t0_3), .Y3(t1_3),
...
// latency=3, gap=1024
   codeBlock86548 stage1(.clk(clk), .reset(reset), .next_in(next_1), .next_out(next_2),
       .X0_in(t1_0), .Y0(t2_0),
       .X1_in(t1_1), .Y1(t2_1),
       .X2_in(t1_2), .Y2(t2_2),
       .X3_in(t1_3), .Y3(t2_3),
...
// latency=8, gap=1024
   rc86761 stage2(.clk(clk), .reset(reset), .next(next_2), .next_out(next_3),
    .X0(t2_0), .Y0(t3_0),
    .X1(t2_1), .Y1(t3_1),
    .X2(t2_2), .Y2(t3_2),
    .X3(t2_3), .Y3(t3_3),
...
// latency=12, gap=1024
   DirSum_87134 stage3(.next(next_3), .clk(clk), .reset(reset), .next_out(next_4),
       .X0(t3_0), .Y0(t4_0),
       .X1(t3_1), .Y1(t4_1),
       .X2(t3_2), .Y2(t4_2),
       .X3(t3_3), .Y3(t4_3),
...
// latency=3, gap=1024
   codeBlock87137 stage4(.clk(clk), .reset(reset), .next_in(next_4), .next_out(next_5),
       .X0_in(t4_0), .Y0(t5_0),
       .X1_in(t4_1), .Y1(t5_1),
       .X2_in(t4_2), .Y2(t5_2),
       .X3_in(t4_3), .Y3(t5_3),
...
// latency=17, gap=1024
   rc87350 stage5(.clk(clk), .reset(reset), .next(next_5), .next_out(next_6),
    .X0(t5_0), .Y0(t6_0),
    .X1(t5_1), .Y1(t6_1),
    .X2(t5_2), .Y2(t6_2),
    .X3(t5_3), .Y3(t6_3),
...
// latency=12, gap=1024
   DirSum_87819 stage6(.next(next_6), .clk(clk), .reset(reset), .next_out(next_7),
       .X0(t6_0), .Y0(t7_0),
       .X1(t6_1), .Y1(t7_1),
       .X2(t6_2), .Y2(t7_2),
       .X3(t6_3), .Y3(t7_3),
...
// latency=3, gap=1024
   codeBlock87822 stage7(.clk(clk), .reset(reset), .next_in(next_7), .next_out(next_8),
       .X0_in(t7_0), .Y0(t8_0),
       .X1_in(t7_1), .Y1(t8_1),
       .X2_in(t7_2), .Y2(t8_2),
       .X3_in(t7_3), .Y3(t8_3),
...
// latency=53, gap=1024
   rc88035 stage8(.clk(clk), .reset(reset), .next(next_8), .next_out(next_9),
    .X0(t8_0), .Y0(t9_0),
    .X1(t8_1), .Y1(t9_1),
    .X2(t8_2), .Y2(t9_2),
    .X3(t8_3), .Y3(t9_3),
...
// latency=12, gap=1024
   DirSum_88888 stage9(.next(next_9), .clk(clk), .reset(reset), .next_out(next_10),
       .X0(t9_0), .Y0(t10_0),
       .X1(t9_1), .Y1(t10_1),
       .X2(t9_2), .Y2(t10_2),
       .X3(t9_3), .Y3(t10_3),
...
// latency=3, gap=1024
   codeBlock88891 stage10(.clk(clk), .reset(reset), .next_in(next_10), .next_out(next_11),
...
// latency=197, gap=1024
   rc89104 stage11(.clk(clk), .reset(reset), .next(next_11), .next_out(next_12),
    .X0(t11_0), .Y0(t12_0),
    .X1(t11_1), .Y1(t12_1),
    .X2(t11_2), .Y2(t12_2),
    .X3(t11_3), .Y3(t12_3),
...
// latency=12, gap=1024
   DirSum_91493 stage12(.next(next_12), .clk(clk), .reset(reset), .next_out(next_13),
       .X0(t12_0), .Y0(t13_0),
       .X1(t12_1), .Y1(t13_1),
       .X2(t12_2), .Y2(t13_2),
       .X3(t12_3), .Y3(t13_3),
...
// latency=3, gap=1024
   codeBlock91496 stage13(.clk(clk), .reset(reset), .next_in(next_13), .next_out(next_14),
...
// latency=773, gap=1024
   rc91709 stage14(.clk(clk), .reset(reset), .next(next_14), .next_out(next_15),
    .X0(t14_0), .Y0(t15_0),
    .X1(t14_1), .Y1(t15_1),
    .X2(t14_2), .Y2(t15_2),
    .X3(t14_3), .Y3(t15_3),
...
// latency=12, gap=1024
   DirSum_100241 stage15(.next(next_15), .clk(clk), .reset(reset), .next_out(next_16),
       .X0(t15_0), .Y0(t16_0),
       .X1(t15_1), .Y1(t16_1),
       .X2(t15_2), .Y2(t16_2),
       .X3(t15_3), .Y3(t16_3),
...
// latency=3, gap=1024
   codeBlock100244 stage16(.clk(clk), .reset(reset), .next_in(next_16), .next_out(next_17),
...
// latency=773, gap=1024
   rc100457 stage17(.clk(clk), .reset(reset), .next(next_17), .next_out(next_18),
    .X0(t17_0), .Y0(t18_0),
    .X1(t17_1), .Y1(t18_1),
    .X2(t17_2), .Y2(t18_2),
    .X3(t17_3), .Y3(t18_3),
...
// Latency: 998
// Gap: 1024
module rc86546(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm86544 instPerm102210(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
...
// Latency: 998
// Gap: 1024
module perm86544(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(994, 10) nextReg_102215(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102218(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_86544 #(numBanks, logBanks, depth, logDepth, width)
...
module memArray4096_86544(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   nextReg #(1024, 10) nextReg_102223(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 3
// Gap: 1
module codeBlock86548(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_102230(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t769;
    ...
    addfxp #(32, 1) add86560(.a(a618), .b(a619), .clk(clk), .q(t754));    // 0
    addfxp #(32, 1) add86575(.a(a620), .b(a621), .clk(clk), .q(t755));    // 0
    subfxp #(32, 1) sub86590(.a(a618), .b(a619), .clk(clk), .q(t756));    // 0
    subfxp #(32, 1) sub86605(.a(a620), .b(a621), .clk(clk), .q(t757));    // 0
    addfxp #(32, 1) add86620(.a(a626), .b(a627), .clk(clk), .q(t758));    // 0
    addfxp #(32, 1) add86635(.a(a628), .b(a629), .clk(clk), .q(t759));    // 0
    subfxp #(32, 1) sub86650(.a(a626), .b(a627), .clk(clk), .q(t760));    // 0
    subfxp #(32, 1) sub86665(.a(a628), .b(a629), .clk(clk), .q(t761));    // 0
    addfxp #(32, 1) add86672(.a(t754), .b(t758), .clk(clk), .q(t762));    // 1
    addfxp #(32, 1) add86679(.a(t755), .b(t759), .clk(clk), .q(t763));    // 1
    subfxp #(32, 1) sub86686(.a(t754), .b(t758), .clk(clk), .q(t764));    // 1
    subfxp #(32, 1) sub86693(.a(t755), .b(t759), .clk(clk), .q(t765));    // 1
    addfxp #(32, 1) add86716(.a(t756), .b(t761), .clk(clk), .q(t766));    // 1
    subfxp #(32, 1) sub86723(.a(t757), .b(t760), .clk(clk), .q(t767));    // 1
    subfxp #(32, 1) sub86730(.a(t756), .b(t761), .clk(clk), .q(t768));    // 1
    addfxp #(32, 1) add86737(.a(t757), .b(t760), .clk(clk), .q(t769));    // 1
...
// Latency: 8
// Gap: 4
module rc86761(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm86759 instPerm102231(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 8
// Gap: 4
module perm86759(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   shiftRegFIFO #(4, 1) shiftFIFO_102234(.X(next), .Y(next0), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102237(.X(next0), .Y(next_out), .clk(clk));


   memArray16_86759 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray16_86759(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   shiftRegFIFO #(4, 1) shiftFIFO_102240(.X(next), .Y(next0), .clk(clk));
...
// Latency: 12
// Gap: 4
module DirSum_87134(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock86764 codeBlockIsnt102241(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i5_in(i5),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock86764(clk, reset, next_in, next_out,
   i5_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_102244(.X(next), .Y(next_out), .clk(clk));
   ...
   D50_87090 instD50inst0_87090(.addr(i5[1:0]), .out(tm7), .clk(clk));

   D44_87102 instD44inst0_87102(.addr(i5[1:0]), .out(tm2), .clk(clk));

   D49_87108 instD49inst0_87108(.addr(i5[1:0]), .out(tm5), .clk(clk));

   D45_87114 instD45inst0_87114(.addr(i5[1:0]), .out(tm4), .clk(clk));

   D48_87120 instD48inst0_87120(.addr(i5[1:0]), .out(tm3), .clk(clk));

   D46_87126 instD46inst0_87126(.addr(i5[1:0]), .out(tm6), .clk(clk));

    multfix #(32, 6) m86863(.a(tm44), .b(tm193), .clk(clk), .q_sc(a569), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86885(.a(tm45), .b(tm197), .clk(clk), .q_sc(a571), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86903(.a(tm45), .b(tm193), .clk(clk), .q_sc(a572), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86914(.a(tm44), .b(tm197), .clk(clk), .q_sc(a573), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86943(.a(tm48), .b(tm209), .clk(clk), .q_sc(a575), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86965(.a(tm49), .b(tm213), .clk(clk), .q_sc(a577), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86983(.a(tm49), .b(tm209), .clk(clk), .q_sc(a578), .q_unsc(), .rst(reset));
    multfix #(32, 6) m86994(.a(tm48), .b(tm213), .clk(clk), .q_sc(a579), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87023(.a(tm52), .b(tm225), .clk(clk), .q_sc(a581), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87045(.a(tm53), .b(tm229), .clk(clk), .q_sc(a583), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87063(.a(tm53), .b(tm225), .clk(clk), .q_sc(a584), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87074(.a(tm52), .b(tm229), .clk(clk), .q_sc(a585), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub86892(.a(a569), .b(a571), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add86921(.a(a572), .b(a573), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub86972(.a(a575), .b(a577), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add87001(.a(a578), .b(a579), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub87052(.a(a581), .b(a583), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add87081(.a(a584), .b(a585), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock87137(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_102247(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t641;
    ...
    addfxp #(32, 1) add87149(.a(a498), .b(a499), .clk(clk), .q(t626));    // 0
    addfxp #(32, 1) add87164(.a(a500), .b(a501), .clk(clk), .q(t627));    // 0
    subfxp #(32, 1) sub87179(.a(a498), .b(a499), .clk(clk), .q(t628));    // 0
    subfxp #(32, 1) sub87194(.a(a500), .b(a501), .clk(clk), .q(t629));    // 0
    addfxp #(32, 1) add87209(.a(a506), .b(a507), .clk(clk), .q(t630));    // 0
    addfxp #(32, 1) add87224(.a(a508), .b(a509), .clk(clk), .q(t631));    // 0
    subfxp #(32, 1) sub87239(.a(a506), .b(a507), .clk(clk), .q(t632));    // 0
    subfxp #(32, 1) sub87254(.a(a508), .b(a509), .clk(clk), .q(t633));    // 0
    addfxp #(32, 1) add87261(.a(t626), .b(t630), .clk(clk), .q(t634));    // 1
    addfxp #(32, 1) add87268(.a(t627), .b(t631), .clk(clk), .q(t635));    // 1
    subfxp #(32, 1) sub87275(.a(t626), .b(t630), .clk(clk), .q(t636));    // 1
    subfxp #(32, 1) sub87282(.a(t627), .b(t631), .clk(clk), .q(t637));    // 1
    addfxp #(32, 1) add87305(.a(t628), .b(t633), .clk(clk), .q(t638));    // 1
    subfxp #(32, 1) sub87312(.a(t629), .b(t632), .clk(clk), .q(t639));    // 1
    subfxp #(32, 1) sub87319(.a(t628), .b(t633), .clk(clk), .q(t640));    // 1
    addfxp #(32, 1) add87326(.a(t629), .b(t632), .clk(clk), .q(t641));    // 1
...
// Latency: 17
// Gap: 16
module rc87350(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm87348 instPerm102248(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 17
// Gap: 16
module perm87348(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(13, 4) nextReg_102253(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102256(.X(next0), .Y(next_out), .clk(clk));


   memArray64_87348 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray64_87348(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(16, 4) nextReg_102261(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 16
module DirSum_87819(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock87353 codeBlockIsnt102266(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i4_in(i4),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock87353(clk, reset, next_in, next_out,
   i4_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_102269(.X(next), .Y(next_out), .clk(clk));
   ...
   D34_87709 instD34inst0_87709(.addr(i4[3:0]), .out(tm10), .clk(clk));

   D35_87727 instD35inst0_87727(.addr(i4[3:0]), .out(tm12), .clk(clk));

   D36_87745 instD36inst0_87745(.addr(i4[3:0]), .out(tm14), .clk(clk));

   D38_87781 instD38inst0_87781(.addr(i4[3:0]), .out(tm11), .clk(clk));

   D39_87799 instD39inst0_87799(.addr(i4[3:0]), .out(tm13), .clk(clk));

   D40_87817 instD40inst0_87817(.addr(i4[3:0]), .out(tm15), .clk(clk));

    multfix #(32, 6) m87452(.a(tm60), .b(tm263), .clk(clk), .q_sc(a449), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87474(.a(tm61), .b(tm267), .clk(clk), .q_sc(a451), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87492(.a(tm61), .b(tm263), .clk(clk), .q_sc(a452), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87503(.a(tm60), .b(tm267), .clk(clk), .q_sc(a453), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87532(.a(tm64), .b(tm279), .clk(clk), .q_sc(a455), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87554(.a(tm65), .b(tm283), .clk(clk), .q_sc(a457), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87572(.a(tm65), .b(tm279), .clk(clk), .q_sc(a458), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87583(.a(tm64), .b(tm283), .clk(clk), .q_sc(a459), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87612(.a(tm68), .b(tm295), .clk(clk), .q_sc(a461), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87634(.a(tm69), .b(tm299), .clk(clk), .q_sc(a463), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87652(.a(tm69), .b(tm295), .clk(clk), .q_sc(a464), .q_unsc(), .rst(reset));
    multfix #(32, 6) m87663(.a(tm68), .b(tm299), .clk(clk), .q_sc(a465), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub87481(.a(a449), .b(a451), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add87510(.a(a452), .b(a453), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub87561(.a(a455), .b(a457), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add87590(.a(a458), .b(a459), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub87641(.a(a461), .b(a463), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add87670(.a(a464), .b(a465), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock87822(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_102272(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t513;
    ...
    addfxp #(32, 1) add87834(.a(a377), .b(a378), .clk(clk), .q(t498));    // 0
    addfxp #(32, 1) add87849(.a(a379), .b(a380), .clk(clk), .q(t499));    // 0
    subfxp #(32, 1) sub87864(.a(a377), .b(a378), .clk(clk), .q(t500));    // 0
    subfxp #(32, 1) sub87879(.a(a379), .b(a380), .clk(clk), .q(t501));    // 0
    addfxp #(32, 1) add87894(.a(a385), .b(a387), .clk(clk), .q(t502));    // 0
    addfxp #(32, 1) add87909(.a(a388), .b(a389), .clk(clk), .q(t503));    // 0
    subfxp #(32, 1) sub87924(.a(a385), .b(a387), .clk(clk), .q(t504));    // 0
    subfxp #(32, 1) sub87939(.a(a388), .b(a389), .clk(clk), .q(t505));    // 0
    addfxp #(32, 1) add87946(.a(t498), .b(t502), .clk(clk), .q(t506));    // 1
    addfxp #(32, 1) add87953(.a(t499), .b(t503), .clk(clk), .q(t507));    // 1
    subfxp #(32, 1) sub87960(.a(t498), .b(t502), .clk(clk), .q(t508));    // 1
    subfxp #(32, 1) sub87967(.a(t499), .b(t503), .clk(clk), .q(t509));    // 1
    addfxp #(32, 1) add87990(.a(t500), .b(t505), .clk(clk), .q(t510));    // 1
    subfxp #(32, 1) sub87997(.a(t501), .b(t504), .clk(clk), .q(t511));    // 1
    subfxp #(32, 1) sub88004(.a(t500), .b(t505), .clk(clk), .q(t512));    // 1
    addfxp #(32, 1) add88011(.a(t501), .b(t504), .clk(clk), .q(t513));    // 1
...
// Latency: 53
// Gap: 64
module rc88035(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm88033 instPerm102273(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 53
// Gap: 64
module perm88033(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(49, 6) nextReg_102278(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102281(.X(next0), .Y(next_out), .clk(clk));


   memArray256_88033 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray256_88033(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(64, 6) nextReg_102286(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 64
module DirSum_88888(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock88038 codeBlockIsnt102291(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i3_in(i3),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock88038(clk, reset, next_in, next_out,
   i3_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_102294(.X(next), .Y(next_out), .clk(clk));
   ...
   D25_88424 instD25inst0_88424(.addr(i3[5:0]), .out(tm20), .clk(clk));

   D28_88490 instD28inst0_88490(.addr(i3[5:0]), .out(tm19), .clk(clk));

   D24_88556 instD24inst0_88556(.addr(i3[5:0]), .out(tm18), .clk(clk));

   D29_88622 instD29inst0_88622(.addr(i3[5:0]), .out(tm21), .clk(clk));

   D30_88754 instD30inst0_88754(.addr(i3[5:0]), .out(tm23), .clk(clk));

   D26_88820 instD26inst0_88820(.addr(i3[5:0]), .out(tm22), .clk(clk));

    multfix #(32, 6) m88137(.a(tm76), .b(tm333), .clk(clk), .q_sc(a328), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88159(.a(tm77), .b(tm337), .clk(clk), .q_sc(a330), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88177(.a(tm77), .b(tm333), .clk(clk), .q_sc(a331), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88188(.a(tm76), .b(tm337), .clk(clk), .q_sc(a332), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88217(.a(tm80), .b(tm349), .clk(clk), .q_sc(a334), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88239(.a(tm81), .b(tm353), .clk(clk), .q_sc(a336), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88257(.a(tm81), .b(tm349), .clk(clk), .q_sc(a337), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88268(.a(tm80), .b(tm353), .clk(clk), .q_sc(a338), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88297(.a(tm84), .b(tm365), .clk(clk), .q_sc(a340), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88319(.a(tm85), .b(tm369), .clk(clk), .q_sc(a342), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88337(.a(tm85), .b(tm365), .clk(clk), .q_sc(a343), .q_unsc(), .rst(reset));
    multfix #(32, 6) m88348(.a(tm84), .b(tm369), .clk(clk), .q_sc(a344), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub88166(.a(a328), .b(a330), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add88195(.a(a331), .b(a332), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub88246(.a(a334), .b(a336), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add88275(.a(a337), .b(a338), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub88326(.a(a340), .b(a342), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add88355(.a(a343), .b(a344), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock88891(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_102297(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t384;
    ...
    addfxp #(32, 1) add88903(.a(a257), .b(a258), .clk(clk), .q(t369));    // 0
    addfxp #(32, 1) add88918(.a(a259), .b(a260), .clk(clk), .q(t370));    // 0
    subfxp #(32, 1) sub88933(.a(a257), .b(a258), .clk(clk), .q(t371));    // 0
    subfxp #(32, 1) sub88948(.a(a259), .b(a260), .clk(clk), .q(t372));    // 0
    addfxp #(32, 1) add88963(.a(a265), .b(a266), .clk(clk), .q(t373));    // 0
    addfxp #(32, 1) add88978(.a(a267), .b(a268), .clk(clk), .q(t374));    // 0
    subfxp #(32, 1) sub88993(.a(a265), .b(a266), .clk(clk), .q(t375));    // 0
    subfxp #(32, 1) sub89008(.a(a267), .b(a268), .clk(clk), .q(t376));    // 0
    addfxp #(32, 1) add89015(.a(t369), .b(t373), .clk(clk), .q(t377));    // 1
    addfxp #(32, 1) add89022(.a(t370), .b(t374), .clk(clk), .q(t378));    // 1
    subfxp #(32, 1) sub89029(.a(t369), .b(t373), .clk(clk), .q(t379));    // 1
    subfxp #(32, 1) sub89036(.a(t370), .b(t374), .clk(clk), .q(t380));    // 1
    addfxp #(32, 1) add89059(.a(t371), .b(t376), .clk(clk), .q(t381));    // 1
    subfxp #(32, 1) sub89066(.a(t372), .b(t375), .clk(clk), .q(t382));    // 1
    subfxp #(32, 1) sub89073(.a(t371), .b(t376), .clk(clk), .q(t383));    // 1
    addfxp #(32, 1) add89080(.a(t372), .b(t375), .clk(clk), .q(t384));    // 1
...
// Latency: 197
// Gap: 256
module rc89104(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm89102 instPerm102298(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 197
// Gap: 256
module perm89102(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(193, 8) nextReg_102303(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102306(.X(next0), .Y(next_out), .clk(clk));


   memArray1024_89102 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray1024_89102(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(256, 8) nextReg_102311(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 256
module DirSum_91493(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock89107 codeBlockIsnt102316(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i2_in(i2),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock89107(clk, reset, next_in, next_out,
   i2_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_102319(.X(next), .Y(next_out), .clk(clk));
   ...
   D18_89685 instD18inst0_89685(.addr(i2[7:0]), .out(tm27), .clk(clk));

   D14_89943 instD14inst0_89943(.addr(i2[7:0]), .out(tm26), .clk(clk));

   D20_90201 instD20inst0_90201(.addr(i2[7:0]), .out(tm31), .clk(clk));

   D16_90459 instD16inst0_90459(.addr(i2[7:0]), .out(tm30), .clk(clk));

   D19_90717 instD19inst0_90717(.addr(i2[7:0]), .out(tm29), .clk(clk));

   D15_90975 instD15inst0_90975(.addr(i2[7:0]), .out(tm28), .clk(clk));

    multfix #(32, 6) m89206(.a(tm92), .b(tm403), .clk(clk), .q_sc(a208), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89228(.a(tm93), .b(tm407), .clk(clk), .q_sc(a210), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89246(.a(tm93), .b(tm403), .clk(clk), .q_sc(a211), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89257(.a(tm92), .b(tm407), .clk(clk), .q_sc(a212), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89286(.a(tm96), .b(tm419), .clk(clk), .q_sc(a214), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89308(.a(tm97), .b(tm423), .clk(clk), .q_sc(a216), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89326(.a(tm97), .b(tm419), .clk(clk), .q_sc(a217), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89337(.a(tm96), .b(tm423), .clk(clk), .q_sc(a218), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89366(.a(tm100), .b(tm435), .clk(clk), .q_sc(a220), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89388(.a(tm101), .b(tm439), .clk(clk), .q_sc(a222), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89406(.a(tm101), .b(tm435), .clk(clk), .q_sc(a223), .q_unsc(), .rst(reset));
    multfix #(32, 6) m89417(.a(tm100), .b(tm439), .clk(clk), .q_sc(a224), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub89235(.a(a208), .b(a210), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add89264(.a(a211), .b(a212), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub89315(.a(a214), .b(a216), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add89344(.a(a217), .b(a218), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub89395(.a(a220), .b(a222), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add89424(.a(a223), .b(a224), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock91496(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_102322(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t256;
    ...
    addfxp #(32, 1) add91508(.a(a137), .b(a138), .clk(clk), .q(t241));    // 0
    addfxp #(32, 1) add91523(.a(a139), .b(a140), .clk(clk), .q(t242));    // 0
    subfxp #(32, 1) sub91538(.a(a137), .b(a138), .clk(clk), .q(t243));    // 0
    subfxp #(32, 1) sub91553(.a(a139), .b(a140), .clk(clk), .q(t244));    // 0
    addfxp #(32, 1) add91568(.a(a145), .b(a146), .clk(clk), .q(t245));    // 0
    addfxp #(32, 1) add91583(.a(a147), .b(a148), .clk(clk), .q(t246));    // 0
    subfxp #(32, 1) sub91598(.a(a145), .b(a146), .clk(clk), .q(t247));    // 0
    subfxp #(32, 1) sub91613(.a(a147), .b(a148), .clk(clk), .q(t248));    // 0
    addfxp #(32, 1) add91620(.a(t241), .b(t245), .clk(clk), .q(t249));    // 1
    addfxp #(32, 1) add91627(.a(t242), .b(t246), .clk(clk), .q(t250));    // 1
    subfxp #(32, 1) sub91634(.a(t241), .b(t245), .clk(clk), .q(t251));    // 1
    subfxp #(32, 1) sub91641(.a(t242), .b(t246), .clk(clk), .q(t252));    // 1
    addfxp #(32, 1) add91664(.a(t243), .b(t248), .clk(clk), .q(t253));    // 1
    subfxp #(32, 1) sub91671(.a(t244), .b(t247), .clk(clk), .q(t254));    // 1
    subfxp #(32, 1) sub91678(.a(t243), .b(t248), .clk(clk), .q(t255));    // 1
    addfxp #(32, 1) add91685(.a(t244), .b(t247), .clk(clk), .q(t256));    // 1
...
// Latency: 773
// Gap: 1024
module rc91709(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm91707 instPerm102323(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 773
// Gap: 1024
module perm91707(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(769, 10) nextReg_102328(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102331(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_91707 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray4096_91707(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(1024, 10) nextReg_102336(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 1024
module DirSum_100241(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock91711 codeBlockIsnt102341(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i1_in(i1),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock91711(clk, reset, next_in, next_out,
   i1_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_102344(.X(next), .Y(next_out), .clk(clk));
   ...
   D6_93057 instD6inst0_93057(.addr(i1[9:0]), .out(tm38), .clk(clk));

   D8_95109 instD8inst0_95109(.addr(i1[9:0]), .out(tm35), .clk(clk));

   D9_96135 instD9inst0_96135(.addr(i1[9:0]), .out(tm37), .clk(clk));

   D10_97161 instD10inst0_97161(.addr(i1[9:0]), .out(tm39), .clk(clk));

   D5_98187 instD5inst0_98187(.addr(i1[9:0]), .out(tm36), .clk(clk));

   D4_99213 instD4inst0_99213(.addr(i1[9:0]), .out(tm34), .clk(clk));

    multfix #(32, 6) m91810(.a(tm108), .b(tm473), .clk(clk), .q_sc(a88), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91832(.a(tm109), .b(tm477), .clk(clk), .q_sc(a90), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91850(.a(tm109), .b(tm473), .clk(clk), .q_sc(a91), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91861(.a(tm108), .b(tm477), .clk(clk), .q_sc(a92), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91890(.a(tm112), .b(tm489), .clk(clk), .q_sc(a94), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91912(.a(tm113), .b(tm493), .clk(clk), .q_sc(a96), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91930(.a(tm113), .b(tm489), .clk(clk), .q_sc(a97), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91941(.a(tm112), .b(tm493), .clk(clk), .q_sc(a98), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91970(.a(tm116), .b(tm505), .clk(clk), .q_sc(a100), .q_unsc(), .rst(reset));
    multfix #(32, 6) m91992(.a(tm117), .b(tm509), .clk(clk), .q_sc(a102), .q_unsc(), .rst(reset));
    multfix #(32, 6) m92010(.a(tm117), .b(tm505), .clk(clk), .q_sc(a103), .q_unsc(), .rst(reset));
    multfix #(32, 6) m92021(.a(tm116), .b(tm509), .clk(clk), .q_sc(a104), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub91839(.a(a88), .b(a90), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add91868(.a(a91), .b(a92), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub91919(.a(a94), .b(a96), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add91948(.a(a97), .b(a98), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub91999(.a(a100), .b(a102), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add92028(.a(a103), .b(a104), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock100244(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_102347(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t128;
    ...
    addfxp #(32, 1) add100256(.a(a17), .b(a18), .clk(clk), .q(t113));    // 0
    addfxp #(32, 1) add100271(.a(a19), .b(a20), .clk(clk), .q(t114));    // 0
    subfxp #(32, 1) sub100286(.a(a17), .b(a18), .clk(clk), .q(t115));    // 0
    subfxp #(32, 1) sub100301(.a(a19), .b(a20), .clk(clk), .q(t116));    // 0
    addfxp #(32, 1) add100316(.a(a25), .b(a26), .clk(clk), .q(t117));    // 0
    addfxp #(32, 1) add100331(.a(a27), .b(a28), .clk(clk), .q(t118));    // 0
    subfxp #(32, 1) sub100346(.a(a25), .b(a26), .clk(clk), .q(t119));    // 0
    subfxp #(32, 1) sub100361(.a(a27), .b(a28), .clk(clk), .q(t120));    // 0
    addfxp #(32, 1) add100368(.a(t113), .b(t117), .clk(clk), .q(t121));    // 1
    addfxp #(32, 1) add100375(.a(t114), .b(t118), .clk(clk), .q(t122));    // 1
    subfxp #(32, 1) sub100382(.a(t113), .b(t117), .clk(clk), .q(t123));    // 1
    subfxp #(32, 1) sub100389(.a(t114), .b(t118), .clk(clk), .q(t124));    // 1
    addfxp #(32, 1) add100412(.a(t115), .b(t120), .clk(clk), .q(t125));    // 1
    subfxp #(32, 1) sub100419(.a(t116), .b(t119), .clk(clk), .q(t126));    // 1
    subfxp #(32, 1) sub100426(.a(t115), .b(t120), .clk(clk), .q(t127));    // 1
    addfxp #(32, 1) add100433(.a(t116), .b(t119), .clk(clk), .q(t128));    // 1
...
// Latency: 773
// Gap: 1024
module rc100457(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm100455 instPerm102348(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 773
// Gap: 1024
module perm100455(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(769, 10) nextReg_102353(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_102356(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_100455 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray4096_100455(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(1024, 10) nextReg_102361(.X(next), .Y(next0), .reset(reset), .clk(clk));
