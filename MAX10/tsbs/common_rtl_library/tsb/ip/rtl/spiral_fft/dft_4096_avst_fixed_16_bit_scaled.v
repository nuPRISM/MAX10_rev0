...
`define SPIRAL_FFT_ENCAPSULATING_MODULE_NAME dft_4096_fixed_16_bit_scaled_iter_d_bedrock
`define SPIRAL_FFT_DFT_INTERNAL_MODULE_NAME  dft_4096_fixed_16_bit_scaled_iter_d_dft_top
`include "generic_4samples_per_clk_spiral_fft.v"

`define SPIRAL_FFT_ENCAPSULATING_MODULE_NAME dft_4096_fixed_16_bit_scaled_stream_d_bedrock
`define SPIRAL_FFT_DFT_INTERNAL_MODULE_NAME  dft_4096_fixed_16_bit_scaled_stream_d_dft_top
`include "generic_4samples_per_clk_spiral_fft.v"
`include "math_func_package.v"
`default_nettype none
module dft_4096_avst_fixed_16_bit_scaled
#(
...
generate
			if (FFT_IMPLEMENTATION_METHOD == SPIRAL_FFT_SCALED_16BIT_4096_STREAMING_FFT)
			begin
					dft_4096_fixed_16_bit_scaled_stream_d_bedrock
					#(
					...
					dft_4096_fixed_16_bit_scaled_stream_d_bedrock_inst
					(
					.*
					);
			end
			...
			if (FFT_IMPLEMENTATION_METHOD == SPIRAL_FFT_SCALED_16BIT_4096_ITERATIVE_FFT)
			begin			   
					dft_4096_fixed_16_bit_scaled_iter_d_bedrock
					#(
					.NUM_COUNTER_BITS     (NUM_COUNTER_BITS     ), 
					.NUM_FFT_SAMPLES      (NUM_FFT_SAMPLES      ), 
					.NUMBITS_DATA         (NUMBITS_DATA         ),     
					...
					dft_4096_fixed_16_bit_scaled_iter_d_bedrock_inst
					(
					.*
					);
			end
