...
//   Throughput: one transform every 6157 cycles
//   Latency: 7155 cycles
...
//     8 RAMs (2048 words, 32 bits per word)
//     6 ROMs (4096 words, 16 bits per word)

// Generated on Sat Jul 20 20:55:26 EDT 2019

// Latency: 7155 clock cycles
// Throughput: 1 transform every 6157 cycles
...
// This system has a 'gap' of 6157 cycles.  This means that
// 6157 cycles must elapse between the beginning of the input
// vectors.
...
// The system has a latency of 7155 cycles.  This means that
// the 'next_out' will be asserted 7155 cycles after the user
// asserts 'next'.
...
// Latency: 7155
// Gap: 6157
// module_name_is:dft_4096_fixed_16_bit_iter_j
module dft_4096_fixed_16_bit_iter_j(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
...
// latency=998, gap=1024
   rc24618 stage0(.clk(clk), .reset(reset), .next(next_0), .next_out(next_1),
    .X0(t0_0), .Y0(t1_0),
    .X1(t0_1), .Y1(t1_1),
    .X2(t0_2), .Y2(t1_2),
    .X3(t0_3), .Y3(t1_3),
...
// latency=6157, gap=6157
   ICompose_33392 IComposeInst33923(.next(next_1), .clk(clk), .reset(reset), .next_out(next_2),
       .X0(t1_0), .Y0(t2_0),
       .X1(t1_1), .Y1(t2_1),
       .X2(t1_2), .Y2(t2_2),
       .X3(t1_3), .Y3(t2_3),
...
// Latency: 998
// Gap: 1024
module rc24618(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm24616 instPerm33924(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
...
// Latency: 998
// Gap: 1024
module perm24616(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(994, 10) nextReg_33929(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_33932(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_24616 #(numBanks, logBanks, depth, logDepth, width)
...
module memArray4096_24616(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   nextReg #(1024, 10) nextReg_33937(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 6157
// Gap: 6157
module ICompose_33392(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   statementList33390 instList33942 (.clk(clk), .reset(reset), .next(int_next), .next_out(int_next_out),
      .i1_in(i1),
    .X0(s0), .Y0(t0),
    .X1(s1), .Y1(t1),
    .X2(s2), .Y2(t2),
...
// Latency: 1025
// Gap: 1024
// module_name_is:statementList33390
module statementList33390(clk, reset, next, next_out,
   i1_in,
   X0, Y0,
   X1, Y1,
   X2, Y2,
...
// latency=11, gap=1024
   DirSum_33173 DirSumInst33945(.next(next_0), .clk(clk), .reset(reset), .next_out(next_1),
.i1(i1_0),
       .X0(t0_0), .Y0(t1_0),
       .X1(t0_1), .Y1(t1_1),
       .X2(t0_2), .Y2(t1_2),
...
// latency=3, gap=1024
   codeBlock33175 codeBlockIsnt33946(.clk(clk), .reset(reset), .next_in(next_1), .next_out(next_2),
       .X0_in(t1_0), .Y0(t2_0),
       .X1_in(t1_1), .Y1(t2_1),
       .X2_in(t1_2), .Y2(t2_2),
       .X3_in(t1_3), .Y3(t2_3),
...
// latency=1011, gap=1024
   rc33388 instrc33947(.clk(clk), .reset(reset), .next(next_2), .next_out(next_3),
    .X0(t2_0), .Y0(t3_0),
    .X1(t2_1), .Y1(t3_1),
    .X2(t2_2), .Y2(t3_2),
    .X3(t2_3), .Y3(t3_3),
...
// Latency: 11
// Gap: 1024
module DirSum_33173(clk, reset, next, next_out,
      i1,
      X0, Y0,
      X1, Y1,
      X2, Y2,
   ...
   codeBlock24620 codeBlockIsnt33948(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i2_in(i2),
.i1_in(i1),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
...
// Latency: 11
// Gap: 1
module codeBlock24620(clk, reset, next_in, next_out,
   i2_in,
   i1_in,
   X0_in, Y0,
   X1_in, Y1,
   ...
   shiftRegFIFO #(10, 1) shiftFIFO_33951(.X(next), .Y(next_out), .clk(clk));
   ...
   D3_29073 instD3inst0_29073(.addr(a172[11:0]), .out(tm6), .clk(clk));

   D3_29073 instD3inst1_29073(.addr(a182[11:0]), .out(tm10), .clk(clk));

   D3_29073 instD3inst2_29073(.addr(a192[11:0]), .out(tm14), .clk(clk));

   D4_33171 instD4inst0_33171(.addr(a172[11:0]), .out(tm7), .clk(clk));

   D4_33171 instD4inst1_33171(.addr(a182[11:0]), .out(tm11), .clk(clk));

   D4_33171 instD4inst2_33171(.addr(a192[11:0]), .out(tm15), .clk(clk));

    addfxp #(13, 1) add24639(.a({1'b0, a165}), .b({12'b0, tm1}), .clk(clk), .q(a166));    // 0
    addfxp #(13, 1) add24765(.a({1'b0, a165}), .b({11'b0, tm8}), .clk(clk), .q(a179));    // 0
    addfxp #(13, 1) add24872(.a({1'b0, a165}), .b({11'b0, tm4}), .clk(clk), .q(a189));    // 0
    subfxp #(13, 1) sub24678(.a({1'b0, a171}), .b({2'b0, tm5}), .clk(clk), .q(a172));    // 2
    subfxp #(13, 1) sub24785(.a({1'b0, a181}), .b({2'b0, tm5}), .clk(clk), .q(a182));    // 2
    subfxp #(13, 1) sub24892(.a({1'b0, a191}), .b({2'b0, tm5}), .clk(clk), .q(a192));    // 2
    multfix #(16, 2) m24700(.a(tm16), .b(tm51), .clk(clk), .q_sc(a174), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24722(.a(tm17), .b(tm58), .clk(clk), .q_sc(a176), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24740(.a(tm17), .b(tm51), .clk(clk), .q_sc(a177), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24751(.a(tm16), .b(tm58), .clk(clk), .q_sc(a178), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24807(.a(tm20), .b(tm80), .clk(clk), .q_sc(a184), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24829(.a(tm21), .b(tm87), .clk(clk), .q_sc(a186), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24847(.a(tm21), .b(tm80), .clk(clk), .q_sc(a187), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24858(.a(tm20), .b(tm87), .clk(clk), .q_sc(a188), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24914(.a(tm24), .b(tm109), .clk(clk), .q_sc(a194), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24936(.a(tm25), .b(tm116), .clk(clk), .q_sc(a196), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24954(.a(tm25), .b(tm109), .clk(clk), .q_sc(a197), .q_unsc(), .rst(reset));
    multfix #(16, 2) m24965(.a(tm24), .b(tm116), .clk(clk), .q_sc(a198), .q_unsc(), .rst(reset));
    subfxp #(16, 1) sub24729(.a(a174), .b(a176), .clk(clk), .q(Y2));    // 9
    addfxp #(16, 1) add24758(.a(a177), .b(a178), .clk(clk), .q(Y3));    // 9
    subfxp #(16, 1) sub24836(.a(a184), .b(a186), .clk(clk), .q(Y4));    // 9
    addfxp #(16, 1) add24865(.a(a187), .b(a188), .clk(clk), .q(Y5));    // 9
    subfxp #(16, 1) sub24943(.a(a194), .b(a196), .clk(clk), .q(Y6));    // 9
    addfxp #(16, 1) add24972(.a(a197), .b(a198), .clk(clk), .q(Y7));    // 9
...
// Latency: 3
// Gap: 1
module codeBlock33175(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_33954(.X(next), .Y(next_out), .clk(clk));
   ...
   assign a27 = X3;
   assign a28 = X7;
   assign t113 = tm28[16:1];
   assign t114 = tm29[16:1];
   assign t115 = tm30[16:1];
   assign t116 = tm31[16:1];
   assign t117 = tm32[16:1];
   assign t118 = tm33[16:1];
   assign t119 = tm34[16:1];
   assign t120 = tm35[16:1];
   assign Y0 = t121;
   assign Y1 = t122;
   assign Y4 = t123;
   assign Y5 = t124;
   ...
   assign Y6 = t127;
   assign Y7 = t128;
   assign t121 = tm36[16:1];
   assign t122 = tm37[16:1];
   assign t123 = tm38[16:1];
   assign t124 = tm39[16:1];
   assign t125 = tm40[16:1];
   assign t126 = tm41[16:1];
   assign t127 = tm42[16:1];
   assign t128 = tm43[16:1];

    addfxp #(17, 1) add33187(.a({{1{a17[15]}}, a17}), .b({{1{a18[15]}}, a18}), .clk(clk), .q(tm28));    // 0
    addfxp #(17, 1) add33202(.a({{1{a19[15]}}, a19}), .b({{1{a20[15]}}, a20}), .clk(clk), .q(tm29));    // 0
    subfxp #(17, 1) sub33217(.a({{1{a17[15]}}, a17}), .b({{1{a18[15]}}, a18}), .clk(clk), .q(tm30));    // 0
    subfxp #(17, 1) sub33232(.a({{1{a19[15]}}, a19}), .b({{1{a20[15]}}, a20}), .clk(clk), .q(tm31));    // 0
    addfxp #(17, 1) add33247(.a({{1{a25[15]}}, a25}), .b({{1{a26[15]}}, a26}), .clk(clk), .q(tm32));    // 0
    addfxp #(17, 1) add33262(.a({{1{a27[15]}}, a27}), .b({{1{a28[15]}}, a28}), .clk(clk), .q(tm33));    // 0
    subfxp #(17, 1) sub33277(.a({{1{a25[15]}}, a25}), .b({{1{a26[15]}}, a26}), .clk(clk), .q(tm34));    // 0
    subfxp #(17, 1) sub33292(.a({{1{a27[15]}}, a27}), .b({{1{a28[15]}}, a28}), .clk(clk), .q(tm35));    // 0
    addfxp #(17, 1) add33299(.a({{1{t113[15]}}, t113}), .b({{1{t117[15]}}, t117}), .clk(clk), .q(tm36));    // 1
    addfxp #(17, 1) add33306(.a({{1{t114[15]}}, t114}), .b({{1{t118[15]}}, t118}), .clk(clk), .q(tm37));    // 1
    subfxp #(17, 1) sub33313(.a({{1{t113[15]}}, t113}), .b({{1{t117[15]}}, t117}), .clk(clk), .q(tm38));    // 1
    subfxp #(17, 1) sub33320(.a({{1{t114[15]}}, t114}), .b({{1{t118[15]}}, t118}), .clk(clk), .q(tm39));    // 1
    addfxp #(17, 1) add33343(.a({{1{t115[15]}}, t115}), .b({{1{t120[15]}}, t120}), .clk(clk), .q(tm40));    // 1
    subfxp #(17, 1) sub33350(.a({{1{t116[15]}}, t116}), .b({{1{t119[15]}}, t119}), .clk(clk), .q(tm41));    // 1
    subfxp #(17, 1) sub33357(.a({{1{t115[15]}}, t115}), .b({{1{t120[15]}}, t120}), .clk(clk), .q(tm42));    // 1
    addfxp #(17, 1) add33364(.a({{1{t116[15]}}, t116}), .b({{1{t119[15]}}, t119}), .clk(clk), .q(tm43));    // 1
...
// Latency: 1011
// Gap: 1024
module rc33388(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm33386 instPerm33955(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 1009
// Gap: 1024
module perm33386(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(1007, 10) nextReg_33960(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_33963(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_33386 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray4096_33386(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(1024, 10) nextReg_33968(.X(next), .Y(next0), .reset(reset), .clk(clk));
