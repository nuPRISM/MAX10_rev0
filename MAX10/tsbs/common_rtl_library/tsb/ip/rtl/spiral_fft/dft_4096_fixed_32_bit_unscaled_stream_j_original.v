...
// latency=998, gap=1024
   rc61300 stage0(.clk(clk), .reset(reset), .next(next_0), .next_out(next_1),
    .X0(t0_0), .Y0(t1_0),
    .X1(t0_1), .Y1(t1_1),
    .X2(t0_2), .Y2(t1_2),
    .X3(t0_3), .Y3(t1_3),
...
// latency=3, gap=1024
   codeBlock61302 stage1(.clk(clk), .reset(reset), .next_in(next_1), .next_out(next_2),
       .X0_in(t1_0), .Y0(t2_0),
       .X1_in(t1_1), .Y1(t2_1),
       .X2_in(t1_2), .Y2(t2_2),
       .X3_in(t1_3), .Y3(t2_3),
...
// latency=8, gap=1024
   rc61515 stage2(.clk(clk), .reset(reset), .next(next_2), .next_out(next_3),
    .X0(t2_0), .Y0(t3_0),
    .X1(t2_1), .Y1(t3_1),
    .X2(t2_2), .Y2(t3_2),
    .X3(t2_3), .Y3(t3_3),
...
// latency=12, gap=1024
   DirSum_61888 stage3(.next(next_3), .clk(clk), .reset(reset), .next_out(next_4),
       .X0(t3_0), .Y0(t4_0),
       .X1(t3_1), .Y1(t4_1),
       .X2(t3_2), .Y2(t4_2),
       .X3(t3_3), .Y3(t4_3),
...
// latency=3, gap=1024
   codeBlock61891 stage4(.clk(clk), .reset(reset), .next_in(next_4), .next_out(next_5),
       .X0_in(t4_0), .Y0(t5_0),
       .X1_in(t4_1), .Y1(t5_1),
       .X2_in(t4_2), .Y2(t5_2),
       .X3_in(t4_3), .Y3(t5_3),
...
// latency=17, gap=1024
   rc62104 stage5(.clk(clk), .reset(reset), .next(next_5), .next_out(next_6),
    .X0(t5_0), .Y0(t6_0),
    .X1(t5_1), .Y1(t6_1),
    .X2(t5_2), .Y2(t6_2),
    .X3(t5_3), .Y3(t6_3),
...
// latency=12, gap=1024
   DirSum_62573 stage6(.next(next_6), .clk(clk), .reset(reset), .next_out(next_7),
       .X0(t6_0), .Y0(t7_0),
       .X1(t6_1), .Y1(t7_1),
       .X2(t6_2), .Y2(t7_2),
       .X3(t6_3), .Y3(t7_3),
...
// latency=3, gap=1024
   codeBlock62576 stage7(.clk(clk), .reset(reset), .next_in(next_7), .next_out(next_8),
       .X0_in(t7_0), .Y0(t8_0),
       .X1_in(t7_1), .Y1(t8_1),
       .X2_in(t7_2), .Y2(t8_2),
       .X3_in(t7_3), .Y3(t8_3),
...
// latency=53, gap=1024
   rc62789 stage8(.clk(clk), .reset(reset), .next(next_8), .next_out(next_9),
    .X0(t8_0), .Y0(t9_0),
    .X1(t8_1), .Y1(t9_1),
    .X2(t8_2), .Y2(t9_2),
    .X3(t8_3), .Y3(t9_3),
...
// latency=12, gap=1024
   DirSum_63642 stage9(.next(next_9), .clk(clk), .reset(reset), .next_out(next_10),
       .X0(t9_0), .Y0(t10_0),
       .X1(t9_1), .Y1(t10_1),
       .X2(t9_2), .Y2(t10_2),
       .X3(t9_3), .Y3(t10_3),
...
// latency=3, gap=1024
   codeBlock63645 stage10(.clk(clk), .reset(reset), .next_in(next_10), .next_out(next_11),
...
// latency=197, gap=1024
   rc63858 stage11(.clk(clk), .reset(reset), .next(next_11), .next_out(next_12),
    .X0(t11_0), .Y0(t12_0),
    .X1(t11_1), .Y1(t12_1),
    .X2(t11_2), .Y2(t12_2),
    .X3(t11_3), .Y3(t12_3),
...
// latency=12, gap=1024
   DirSum_66247 stage12(.next(next_12), .clk(clk), .reset(reset), .next_out(next_13),
       .X0(t12_0), .Y0(t13_0),
       .X1(t12_1), .Y1(t13_1),
       .X2(t12_2), .Y2(t13_2),
       .X3(t12_3), .Y3(t13_3),
...
// latency=3, gap=1024
   codeBlock66250 stage13(.clk(clk), .reset(reset), .next_in(next_13), .next_out(next_14),
...
// latency=773, gap=1024
   rc66463 stage14(.clk(clk), .reset(reset), .next(next_14), .next_out(next_15),
    .X0(t14_0), .Y0(t15_0),
    .X1(t14_1), .Y1(t15_1),
    .X2(t14_2), .Y2(t15_2),
    .X3(t14_3), .Y3(t15_3),
...
// latency=12, gap=1024
   DirSum_74995 stage15(.next(next_15), .clk(clk), .reset(reset), .next_out(next_16),
       .X0(t15_0), .Y0(t16_0),
       .X1(t15_1), .Y1(t16_1),
       .X2(t15_2), .Y2(t16_2),
       .X3(t15_3), .Y3(t16_3),
...
// latency=3, gap=1024
   codeBlock74998 stage16(.clk(clk), .reset(reset), .next_in(next_16), .next_out(next_17),
...
// latency=773, gap=1024
   rc75211 stage17(.clk(clk), .reset(reset), .next(next_17), .next_out(next_18),
    .X0(t17_0), .Y0(t18_0),
    .X1(t17_1), .Y1(t18_1),
    .X2(t17_2), .Y2(t18_2),
    .X3(t17_3), .Y3(t18_3),
...
// Latency: 998
// Gap: 1024
module rc61300(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm61298 instPerm76964(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
...
// Latency: 998
// Gap: 1024
module perm61298(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(994, 10) nextReg_76969(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_76972(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_61298 #(numBanks, logBanks, depth, logDepth, width)
...
module memArray4096_61298(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   nextReg #(1024, 10) nextReg_76977(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 3
// Gap: 1
module codeBlock61302(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_76984(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t769;
    ...
    addfxp #(32, 1) add61314(.a(a618), .b(a619), .clk(clk), .q(t754));    // 0
    addfxp #(32, 1) add61329(.a(a620), .b(a621), .clk(clk), .q(t755));    // 0
    subfxp #(32, 1) sub61344(.a(a618), .b(a619), .clk(clk), .q(t756));    // 0
    subfxp #(32, 1) sub61359(.a(a620), .b(a621), .clk(clk), .q(t757));    // 0
    addfxp #(32, 1) add61374(.a(a626), .b(a627), .clk(clk), .q(t758));    // 0
    addfxp #(32, 1) add61389(.a(a628), .b(a629), .clk(clk), .q(t759));    // 0
    subfxp #(32, 1) sub61404(.a(a626), .b(a627), .clk(clk), .q(t760));    // 0
    subfxp #(32, 1) sub61419(.a(a628), .b(a629), .clk(clk), .q(t761));    // 0
    addfxp #(32, 1) add61426(.a(t754), .b(t758), .clk(clk), .q(t762));    // 1
    addfxp #(32, 1) add61433(.a(t755), .b(t759), .clk(clk), .q(t763));    // 1
    subfxp #(32, 1) sub61440(.a(t754), .b(t758), .clk(clk), .q(t764));    // 1
    subfxp #(32, 1) sub61447(.a(t755), .b(t759), .clk(clk), .q(t765));    // 1
    addfxp #(32, 1) add61470(.a(t756), .b(t761), .clk(clk), .q(t766));    // 1
    subfxp #(32, 1) sub61477(.a(t757), .b(t760), .clk(clk), .q(t767));    // 1
    subfxp #(32, 1) sub61484(.a(t756), .b(t761), .clk(clk), .q(t768));    // 1
    addfxp #(32, 1) add61491(.a(t757), .b(t760), .clk(clk), .q(t769));    // 1
...
// Latency: 8
// Gap: 4
module rc61515(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm61513 instPerm76985(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 8
// Gap: 4
module perm61513(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   shiftRegFIFO #(4, 1) shiftFIFO_76988(.X(next), .Y(next0), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_76991(.X(next0), .Y(next_out), .clk(clk));


   memArray16_61513 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray16_61513(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   shiftRegFIFO #(4, 1) shiftFIFO_76994(.X(next), .Y(next0), .clk(clk));
...
// Latency: 12
// Gap: 4
module DirSum_61888(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock61518 codeBlockIsnt76995(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i5_in(i5),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock61518(clk, reset, next_in, next_out,
   i5_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_76998(.X(next), .Y(next_out), .clk(clk));
   ...
   D50_61850 instD50inst0_61850(.addr(i5[1:0]), .out(tm7), .clk(clk));

   D44_61856 instD44inst0_61856(.addr(i5[1:0]), .out(tm2), .clk(clk));

   D49_61862 instD49inst0_61862(.addr(i5[1:0]), .out(tm5), .clk(clk));

   D45_61868 instD45inst0_61868(.addr(i5[1:0]), .out(tm4), .clk(clk));

   D48_61874 instD48inst0_61874(.addr(i5[1:0]), .out(tm3), .clk(clk));

   D46_61886 instD46inst0_61886(.addr(i5[1:0]), .out(tm6), .clk(clk));

    multfix #(32, 6) m61617(.a(tm44), .b(tm193), .clk(clk), .q_sc(a569), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61639(.a(tm45), .b(tm197), .clk(clk), .q_sc(a571), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61657(.a(tm45), .b(tm193), .clk(clk), .q_sc(a572), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61668(.a(tm44), .b(tm197), .clk(clk), .q_sc(a573), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61697(.a(tm48), .b(tm209), .clk(clk), .q_sc(a575), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61719(.a(tm49), .b(tm213), .clk(clk), .q_sc(a577), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61737(.a(tm49), .b(tm209), .clk(clk), .q_sc(a578), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61748(.a(tm48), .b(tm213), .clk(clk), .q_sc(a579), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61777(.a(tm52), .b(tm225), .clk(clk), .q_sc(a581), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61799(.a(tm53), .b(tm229), .clk(clk), .q_sc(a583), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61817(.a(tm53), .b(tm225), .clk(clk), .q_sc(a584), .q_unsc(), .rst(reset));
    multfix #(32, 6) m61828(.a(tm52), .b(tm229), .clk(clk), .q_sc(a585), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub61646(.a(a569), .b(a571), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add61675(.a(a572), .b(a573), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub61726(.a(a575), .b(a577), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add61755(.a(a578), .b(a579), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub61806(.a(a581), .b(a583), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add61835(.a(a584), .b(a585), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock61891(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_77001(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t641;
    ...
    addfxp #(32, 1) add61903(.a(a498), .b(a499), .clk(clk), .q(t626));    // 0
    addfxp #(32, 1) add61918(.a(a500), .b(a501), .clk(clk), .q(t627));    // 0
    subfxp #(32, 1) sub61933(.a(a498), .b(a499), .clk(clk), .q(t628));    // 0
    subfxp #(32, 1) sub61948(.a(a500), .b(a501), .clk(clk), .q(t629));    // 0
    addfxp #(32, 1) add61963(.a(a506), .b(a507), .clk(clk), .q(t630));    // 0
    addfxp #(32, 1) add61978(.a(a508), .b(a509), .clk(clk), .q(t631));    // 0
    subfxp #(32, 1) sub61993(.a(a506), .b(a507), .clk(clk), .q(t632));    // 0
    subfxp #(32, 1) sub62008(.a(a508), .b(a509), .clk(clk), .q(t633));    // 0
    addfxp #(32, 1) add62015(.a(t626), .b(t630), .clk(clk), .q(t634));    // 1
    addfxp #(32, 1) add62022(.a(t627), .b(t631), .clk(clk), .q(t635));    // 1
    subfxp #(32, 1) sub62029(.a(t626), .b(t630), .clk(clk), .q(t636));    // 1
    subfxp #(32, 1) sub62036(.a(t627), .b(t631), .clk(clk), .q(t637));    // 1
    addfxp #(32, 1) add62059(.a(t628), .b(t633), .clk(clk), .q(t638));    // 1
    subfxp #(32, 1) sub62066(.a(t629), .b(t632), .clk(clk), .q(t639));    // 1
    subfxp #(32, 1) sub62073(.a(t628), .b(t633), .clk(clk), .q(t640));    // 1
    addfxp #(32, 1) add62080(.a(t629), .b(t632), .clk(clk), .q(t641));    // 1
...
// Latency: 17
// Gap: 16
module rc62104(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm62102 instPerm77002(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 17
// Gap: 16
module perm62102(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(13, 4) nextReg_77007(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_77010(.X(next0), .Y(next_out), .clk(clk));


   memArray64_62102 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray64_62102(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(16, 4) nextReg_77015(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 16
module DirSum_62573(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock62107 codeBlockIsnt77020(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i4_in(i4),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock62107(clk, reset, next_in, next_out,
   i4_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_77023(.X(next), .Y(next_out), .clk(clk));
   ...
   D34_62463 instD34inst0_62463(.addr(i4[3:0]), .out(tm10), .clk(clk));

   D35_62481 instD35inst0_62481(.addr(i4[3:0]), .out(tm12), .clk(clk));

   D36_62499 instD36inst0_62499(.addr(i4[3:0]), .out(tm14), .clk(clk));

   D38_62535 instD38inst0_62535(.addr(i4[3:0]), .out(tm11), .clk(clk));

   D39_62553 instD39inst0_62553(.addr(i4[3:0]), .out(tm13), .clk(clk));

   D40_62571 instD40inst0_62571(.addr(i4[3:0]), .out(tm15), .clk(clk));

    multfix #(32, 6) m62206(.a(tm60), .b(tm263), .clk(clk), .q_sc(a449), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62228(.a(tm61), .b(tm267), .clk(clk), .q_sc(a451), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62246(.a(tm61), .b(tm263), .clk(clk), .q_sc(a452), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62257(.a(tm60), .b(tm267), .clk(clk), .q_sc(a453), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62286(.a(tm64), .b(tm279), .clk(clk), .q_sc(a455), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62308(.a(tm65), .b(tm283), .clk(clk), .q_sc(a457), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62326(.a(tm65), .b(tm279), .clk(clk), .q_sc(a458), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62337(.a(tm64), .b(tm283), .clk(clk), .q_sc(a459), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62366(.a(tm68), .b(tm295), .clk(clk), .q_sc(a461), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62388(.a(tm69), .b(tm299), .clk(clk), .q_sc(a463), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62406(.a(tm69), .b(tm295), .clk(clk), .q_sc(a464), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62417(.a(tm68), .b(tm299), .clk(clk), .q_sc(a465), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub62235(.a(a449), .b(a451), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add62264(.a(a452), .b(a453), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub62315(.a(a455), .b(a457), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add62344(.a(a458), .b(a459), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub62395(.a(a461), .b(a463), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add62424(.a(a464), .b(a465), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock62576(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_77026(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t513;
    ...
    addfxp #(32, 1) add62588(.a(a377), .b(a378), .clk(clk), .q(t498));    // 0
    addfxp #(32, 1) add62603(.a(a379), .b(a380), .clk(clk), .q(t499));    // 0
    subfxp #(32, 1) sub62618(.a(a377), .b(a378), .clk(clk), .q(t500));    // 0
    subfxp #(32, 1) sub62633(.a(a379), .b(a380), .clk(clk), .q(t501));    // 0
    addfxp #(32, 1) add62648(.a(a385), .b(a387), .clk(clk), .q(t502));    // 0
    addfxp #(32, 1) add62663(.a(a388), .b(a389), .clk(clk), .q(t503));    // 0
    subfxp #(32, 1) sub62678(.a(a385), .b(a387), .clk(clk), .q(t504));    // 0
    subfxp #(32, 1) sub62693(.a(a388), .b(a389), .clk(clk), .q(t505));    // 0
    addfxp #(32, 1) add62700(.a(t498), .b(t502), .clk(clk), .q(t506));    // 1
    addfxp #(32, 1) add62707(.a(t499), .b(t503), .clk(clk), .q(t507));    // 1
    subfxp #(32, 1) sub62714(.a(t498), .b(t502), .clk(clk), .q(t508));    // 1
    subfxp #(32, 1) sub62721(.a(t499), .b(t503), .clk(clk), .q(t509));    // 1
    addfxp #(32, 1) add62744(.a(t500), .b(t505), .clk(clk), .q(t510));    // 1
    subfxp #(32, 1) sub62751(.a(t501), .b(t504), .clk(clk), .q(t511));    // 1
    subfxp #(32, 1) sub62758(.a(t500), .b(t505), .clk(clk), .q(t512));    // 1
    addfxp #(32, 1) add62765(.a(t501), .b(t504), .clk(clk), .q(t513));    // 1
...
// Latency: 53
// Gap: 64
module rc62789(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm62787 instPerm77027(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 53
// Gap: 64
module perm62787(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(49, 6) nextReg_77032(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_77035(.X(next0), .Y(next_out), .clk(clk));


   memArray256_62787 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray256_62787(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(64, 6) nextReg_77040(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 64
module DirSum_63642(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock62792 codeBlockIsnt77045(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i3_in(i3),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock62792(clk, reset, next_in, next_out,
   i3_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_77048(.X(next), .Y(next_out), .clk(clk));
   ...
   D25_63178 instD25inst0_63178(.addr(i3[5:0]), .out(tm20), .clk(clk));

   D28_63244 instD28inst0_63244(.addr(i3[5:0]), .out(tm19), .clk(clk));

   D24_63310 instD24inst0_63310(.addr(i3[5:0]), .out(tm18), .clk(clk));

   D29_63376 instD29inst0_63376(.addr(i3[5:0]), .out(tm21), .clk(clk));

   D30_63508 instD30inst0_63508(.addr(i3[5:0]), .out(tm23), .clk(clk));

   D26_63574 instD26inst0_63574(.addr(i3[5:0]), .out(tm22), .clk(clk));

    multfix #(32, 6) m62891(.a(tm76), .b(tm333), .clk(clk), .q_sc(a328), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62913(.a(tm77), .b(tm337), .clk(clk), .q_sc(a330), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62931(.a(tm77), .b(tm333), .clk(clk), .q_sc(a331), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62942(.a(tm76), .b(tm337), .clk(clk), .q_sc(a332), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62971(.a(tm80), .b(tm349), .clk(clk), .q_sc(a334), .q_unsc(), .rst(reset));
    multfix #(32, 6) m62993(.a(tm81), .b(tm353), .clk(clk), .q_sc(a336), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63011(.a(tm81), .b(tm349), .clk(clk), .q_sc(a337), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63022(.a(tm80), .b(tm353), .clk(clk), .q_sc(a338), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63051(.a(tm84), .b(tm365), .clk(clk), .q_sc(a340), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63073(.a(tm85), .b(tm369), .clk(clk), .q_sc(a342), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63091(.a(tm85), .b(tm365), .clk(clk), .q_sc(a343), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63102(.a(tm84), .b(tm369), .clk(clk), .q_sc(a344), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub62920(.a(a328), .b(a330), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add62949(.a(a331), .b(a332), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub63000(.a(a334), .b(a336), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add63029(.a(a337), .b(a338), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub63080(.a(a340), .b(a342), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add63109(.a(a343), .b(a344), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock63645(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_77051(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t384;
    ...
    addfxp #(32, 1) add63657(.a(a257), .b(a258), .clk(clk), .q(t369));    // 0
    addfxp #(32, 1) add63672(.a(a259), .b(a260), .clk(clk), .q(t370));    // 0
    subfxp #(32, 1) sub63687(.a(a257), .b(a258), .clk(clk), .q(t371));    // 0
    subfxp #(32, 1) sub63702(.a(a259), .b(a260), .clk(clk), .q(t372));    // 0
    addfxp #(32, 1) add63717(.a(a265), .b(a266), .clk(clk), .q(t373));    // 0
    addfxp #(32, 1) add63732(.a(a267), .b(a268), .clk(clk), .q(t374));    // 0
    subfxp #(32, 1) sub63747(.a(a265), .b(a266), .clk(clk), .q(t375));    // 0
    subfxp #(32, 1) sub63762(.a(a267), .b(a268), .clk(clk), .q(t376));    // 0
    addfxp #(32, 1) add63769(.a(t369), .b(t373), .clk(clk), .q(t377));    // 1
    addfxp #(32, 1) add63776(.a(t370), .b(t374), .clk(clk), .q(t378));    // 1
    subfxp #(32, 1) sub63783(.a(t369), .b(t373), .clk(clk), .q(t379));    // 1
    subfxp #(32, 1) sub63790(.a(t370), .b(t374), .clk(clk), .q(t380));    // 1
    addfxp #(32, 1) add63813(.a(t371), .b(t376), .clk(clk), .q(t381));    // 1
    subfxp #(32, 1) sub63820(.a(t372), .b(t375), .clk(clk), .q(t382));    // 1
    subfxp #(32, 1) sub63827(.a(t371), .b(t376), .clk(clk), .q(t383));    // 1
    addfxp #(32, 1) add63834(.a(t372), .b(t375), .clk(clk), .q(t384));    // 1
...
// Latency: 197
// Gap: 256
module rc63858(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm63856 instPerm77052(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 197
// Gap: 256
module perm63856(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(193, 8) nextReg_77057(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_77060(.X(next0), .Y(next_out), .clk(clk));


   memArray1024_63856 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray1024_63856(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(256, 8) nextReg_77065(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 256
module DirSum_66247(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock63861 codeBlockIsnt77070(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i2_in(i2),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock63861(clk, reset, next_in, next_out,
   i2_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_77073(.X(next), .Y(next_out), .clk(clk));
   ...
   D18_64697 instD18inst0_64697(.addr(i2[7:0]), .out(tm27), .clk(clk));

   D14_64955 instD14inst0_64955(.addr(i2[7:0]), .out(tm26), .clk(clk));

   D20_65213 instD20inst0_65213(.addr(i2[7:0]), .out(tm31), .clk(clk));

   D16_65471 instD16inst0_65471(.addr(i2[7:0]), .out(tm30), .clk(clk));

   D19_65729 instD19inst0_65729(.addr(i2[7:0]), .out(tm29), .clk(clk));

   D15_65987 instD15inst0_65987(.addr(i2[7:0]), .out(tm28), .clk(clk));

    multfix #(32, 6) m63960(.a(tm92), .b(tm403), .clk(clk), .q_sc(a208), .q_unsc(), .rst(reset));
    multfix #(32, 6) m63982(.a(tm93), .b(tm407), .clk(clk), .q_sc(a210), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64000(.a(tm93), .b(tm403), .clk(clk), .q_sc(a211), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64011(.a(tm92), .b(tm407), .clk(clk), .q_sc(a212), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64040(.a(tm96), .b(tm419), .clk(clk), .q_sc(a214), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64062(.a(tm97), .b(tm423), .clk(clk), .q_sc(a216), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64080(.a(tm97), .b(tm419), .clk(clk), .q_sc(a217), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64091(.a(tm96), .b(tm423), .clk(clk), .q_sc(a218), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64120(.a(tm100), .b(tm435), .clk(clk), .q_sc(a220), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64142(.a(tm101), .b(tm439), .clk(clk), .q_sc(a222), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64160(.a(tm101), .b(tm435), .clk(clk), .q_sc(a223), .q_unsc(), .rst(reset));
    multfix #(32, 6) m64171(.a(tm100), .b(tm439), .clk(clk), .q_sc(a224), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub63989(.a(a208), .b(a210), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add64018(.a(a211), .b(a212), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub64069(.a(a214), .b(a216), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add64098(.a(a217), .b(a218), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub64149(.a(a220), .b(a222), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add64178(.a(a223), .b(a224), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock66250(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_77076(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t256;
    ...
    addfxp #(32, 1) add66262(.a(a137), .b(a138), .clk(clk), .q(t241));    // 0
    addfxp #(32, 1) add66277(.a(a139), .b(a140), .clk(clk), .q(t242));    // 0
    subfxp #(32, 1) sub66292(.a(a137), .b(a138), .clk(clk), .q(t243));    // 0
    subfxp #(32, 1) sub66307(.a(a139), .b(a140), .clk(clk), .q(t244));    // 0
    addfxp #(32, 1) add66322(.a(a145), .b(a146), .clk(clk), .q(t245));    // 0
    addfxp #(32, 1) add66337(.a(a147), .b(a148), .clk(clk), .q(t246));    // 0
    subfxp #(32, 1) sub66352(.a(a145), .b(a146), .clk(clk), .q(t247));    // 0
    subfxp #(32, 1) sub66367(.a(a147), .b(a148), .clk(clk), .q(t248));    // 0
    addfxp #(32, 1) add66374(.a(t241), .b(t245), .clk(clk), .q(t249));    // 1
    addfxp #(32, 1) add66381(.a(t242), .b(t246), .clk(clk), .q(t250));    // 1
    subfxp #(32, 1) sub66388(.a(t241), .b(t245), .clk(clk), .q(t251));    // 1
    subfxp #(32, 1) sub66395(.a(t242), .b(t246), .clk(clk), .q(t252));    // 1
    addfxp #(32, 1) add66418(.a(t243), .b(t248), .clk(clk), .q(t253));    // 1
    subfxp #(32, 1) sub66425(.a(t244), .b(t247), .clk(clk), .q(t254));    // 1
    subfxp #(32, 1) sub66432(.a(t243), .b(t248), .clk(clk), .q(t255));    // 1
    addfxp #(32, 1) add66439(.a(t244), .b(t247), .clk(clk), .q(t256));    // 1
...
// Latency: 773
// Gap: 1024
module rc66463(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm66461 instPerm77077(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 773
// Gap: 1024
module perm66461(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(769, 10) nextReg_77082(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_77085(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_66461 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray4096_66461(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(1024, 10) nextReg_77090(.X(next), .Y(next0), .reset(reset), .clk(clk));
...
// Latency: 12
// Gap: 1024
module DirSum_74995(clk, reset, next, next_out,
      X0, Y0,
      X1, Y1,
      X2, Y2,
      X3, Y3,
   ...
   codeBlock66465 codeBlockIsnt77095(.clk(clk), .reset(reset), .next_in(next), .next_out(next_out),
.i1_in(i1),
       .X0_in(X0), .Y0(Y0),
       .X1_in(X1), .Y1(Y1),
       .X2_in(X2), .Y2(Y2),
...
// Latency: 12
// Gap: 1
module codeBlock66465(clk, reset, next_in, next_out,
   i1_in,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   ...
   shiftRegFIFO #(11, 1) shiftFIFO_77098(.X(next), .Y(next_out), .clk(clk));
   ...
   D6_67811 instD6inst0_67811(.addr(i1[9:0]), .out(tm38), .clk(clk));

   D8_69863 instD8inst0_69863(.addr(i1[9:0]), .out(tm35), .clk(clk));

   D9_70889 instD9inst0_70889(.addr(i1[9:0]), .out(tm37), .clk(clk));

   D10_71915 instD10inst0_71915(.addr(i1[9:0]), .out(tm39), .clk(clk));

   D5_72941 instD5inst0_72941(.addr(i1[9:0]), .out(tm36), .clk(clk));

   D4_73967 instD4inst0_73967(.addr(i1[9:0]), .out(tm34), .clk(clk));

    multfix #(32, 6) m66564(.a(tm108), .b(tm473), .clk(clk), .q_sc(a88), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66586(.a(tm109), .b(tm477), .clk(clk), .q_sc(a90), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66604(.a(tm109), .b(tm473), .clk(clk), .q_sc(a91), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66615(.a(tm108), .b(tm477), .clk(clk), .q_sc(a92), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66644(.a(tm112), .b(tm489), .clk(clk), .q_sc(a94), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66666(.a(tm113), .b(tm493), .clk(clk), .q_sc(a96), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66684(.a(tm113), .b(tm489), .clk(clk), .q_sc(a97), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66695(.a(tm112), .b(tm493), .clk(clk), .q_sc(a98), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66724(.a(tm116), .b(tm505), .clk(clk), .q_sc(a100), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66746(.a(tm117), .b(tm509), .clk(clk), .q_sc(a102), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66764(.a(tm117), .b(tm505), .clk(clk), .q_sc(a103), .q_unsc(), .rst(reset));
    multfix #(32, 6) m66775(.a(tm116), .b(tm509), .clk(clk), .q_sc(a104), .q_unsc(), .rst(reset));
    subfxp #(32, 1) sub66593(.a(a88), .b(a90), .clk(clk), .q(Y2));    // 10
    addfxp #(32, 1) add66622(.a(a91), .b(a92), .clk(clk), .q(Y3));    // 10
    subfxp #(32, 1) sub66673(.a(a94), .b(a96), .clk(clk), .q(Y4));    // 10
    addfxp #(32, 1) add66702(.a(a97), .b(a98), .clk(clk), .q(Y5));    // 10
    subfxp #(32, 1) sub66753(.a(a100), .b(a102), .clk(clk), .q(Y6));    // 10
    addfxp #(32, 1) add66782(.a(a103), .b(a104), .clk(clk), .q(Y7));    // 10
...
// Latency: 3
// Gap: 1
module codeBlock74998(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(2, 1) shiftFIFO_77101(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y7 = t128;
    ...
    addfxp #(32, 1) add75010(.a(a17), .b(a18), .clk(clk), .q(t113));    // 0
    addfxp #(32, 1) add75025(.a(a19), .b(a20), .clk(clk), .q(t114));    // 0
    subfxp #(32, 1) sub75040(.a(a17), .b(a18), .clk(clk), .q(t115));    // 0
    subfxp #(32, 1) sub75055(.a(a19), .b(a20), .clk(clk), .q(t116));    // 0
    addfxp #(32, 1) add75070(.a(a25), .b(a26), .clk(clk), .q(t117));    // 0
    addfxp #(32, 1) add75085(.a(a27), .b(a28), .clk(clk), .q(t118));    // 0
    subfxp #(32, 1) sub75100(.a(a25), .b(a26), .clk(clk), .q(t119));    // 0
    subfxp #(32, 1) sub75115(.a(a27), .b(a28), .clk(clk), .q(t120));    // 0
    addfxp #(32, 1) add75122(.a(t113), .b(t117), .clk(clk), .q(t121));    // 1
    addfxp #(32, 1) add75129(.a(t114), .b(t118), .clk(clk), .q(t122));    // 1
    subfxp #(32, 1) sub75136(.a(t113), .b(t117), .clk(clk), .q(t123));    // 1
    subfxp #(32, 1) sub75143(.a(t114), .b(t118), .clk(clk), .q(t124));    // 1
    addfxp #(32, 1) add75166(.a(t115), .b(t120), .clk(clk), .q(t125));    // 1
    subfxp #(32, 1) sub75173(.a(t116), .b(t119), .clk(clk), .q(t126));    // 1
    subfxp #(32, 1) sub75180(.a(t115), .b(t120), .clk(clk), .q(t127));    // 1
    addfxp #(32, 1) add75187(.a(t116), .b(t119), .clk(clk), .q(t128));    // 1
...
// Latency: 773
// Gap: 1024
module rc75211(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
   ...
   perm75209 instPerm77102(.x0(t0), .y0(s0),
    .x1(t1), .y1(s1),
    .x2(t2), .y2(s2),
    .x3(t3), .y3(s3),
   .clk(clk), .next(next), .next_out(next_out), .reset(reset)
...
// Latency: 773
// Gap: 1024
module perm75209(clk, next, reset, next_out,
   x0, y0,
   x1, y1,
   x2, y2,
   x3, y3);
   ...
   nextReg #(769, 10) nextReg_77107(.X(next), .Y(next0), .reset(reset), .clk(clk));


   shiftRegFIFO #(4, 1) shiftFIFO_77110(.X(next0), .Y(next_out), .clk(clk));


   memArray4096_75209 #(numBanks, logBanks, depth, logDepth, width)
     memSys(.inFlip(inFlip1), .outFlip(outFlip1), .next(next), .reset(reset),
        .x0(w_2_0[width+logDepth-1:logDepth]), .y0(ybuff0),
        .inAddr0(w_2_0[logDepth-1:0]),
        .outAddr0(u_2_0), 
...
module memArray4096_75209(next, reset,
                x0, y0,
                inAddr0,
                outAddr0,
                x1, y1,
   ...
   output [width-1:0]  y3;
   input [logDepth-1:0] inAddr3, outAddr3;
   nextReg #(1024, 10) nextReg_77115(.X(next), .Y(next0), .reset(reset), .clk(clk));
