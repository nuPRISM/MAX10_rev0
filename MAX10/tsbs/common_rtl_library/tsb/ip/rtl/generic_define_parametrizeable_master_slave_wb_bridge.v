...
module `current_wb_bridge_top_module_name
...
`endif
   ...
   parameter dw = 32;
   parameter aw = 32;
   parameter crop_output_addresses = 0;
   parameter bytesel_width = dw/8;
   parameter watchdog_timer_width = 8;
   input [aw-1:0] wbm0_adr_o;input [1:0] wbm0_bte_o;input [2:0]	wbm0_cti_o;input wbm0_cyc_o;input [dw-1:0] wbm0_dat_o;input [(bytesel_width-1):0] wbm0_sel_o;input wbm0_stb_o;input wbm0_we_o;output wbm0_ack_i;output wbm0_err_i;output wbm0_rty_i;output [dw-1:0] wbm0_dat_i;
`ifdef WBM1
   input [aw-1:0] wbm1_adr_o;input [1:0] wbm1_bte_o;input [2:0]	wbm1_cti_o;input wbm1_cyc_o;input [dw-1:0] wbm1_dat_o;input [(bytesel_width-1):0] wbm1_sel_o;input wbm1_stb_o;input wbm1_we_o;output wbm1_ack_i;output wbm1_err_i;output wbm1_rty_i;output [dw-1:0] wbm1_dat_i;   
`endif
`ifdef WBM2
   input [aw-1:0] wbm2_adr_o;input [1:0] wbm2_bte_o;input [2:0]	wbm2_cti_o;input wbm2_cyc_o;input [dw-1:0] wbm2_dat_o;input [(bytesel_width-1):0] wbm2_sel_o;input wbm2_stb_o;input wbm2_we_o;output wbm2_ack_i;output wbm2_err_i;output wbm2_rty_i;output [dw-1:0] wbm2_dat_i;   
`endif
`ifdef WBM3
   input [aw-1:0] wbm3_adr_o;input [1:0] wbm3_bte_o;input [2:0]	wbm3_cti_o;input wbm3_cyc_o;input [dw-1:0] wbm3_dat_o;input [(bytesel_width-1):0] wbm3_sel_o;input wbm3_stb_o;input wbm3_we_o;output wbm3_ack_i;output wbm3_err_i;output wbm3_rty_i;output [dw-1:0] wbm3_dat_i;   
`endif
`ifdef WBM4
   input [aw-1:0] wbm4_adr_o;input [1:0] wbm4_bte_o;input [2:0]	wbm4_cti_o;input wbm4_cyc_o;input [dw-1:0] wbm4_dat_o;input [(bytesel_width-1):0] wbm4_sel_o;input wbm4_stb_o;input wbm4_we_o;output wbm4_ack_i;output wbm4_err_i;output wbm4_rty_i;output [dw-1:0] wbm4_dat_i;   
`endif
`ifdef WBM5
   input [aw-1:0] wbm5_adr_o;input [1:0] wbm5_bte_o;input [2:0]	wbm5_cti_o;input wbm5_cyc_o;input [dw-1:0] wbm5_dat_o;input [(bytesel_width-1):0] wbm5_sel_o;input wbm5_stb_o;input wbm5_we_o;output wbm5_ack_i;output wbm5_err_i;output wbm5_rty_i;output [dw-1:0] wbm5_dat_i;   
`endif

   output [aw-1:0] wbs0_adr_i;output [1:0] wbs0_bte_i;output [2:0]	wbs0_cti_i;output wbs0_cyc_i;output [dw-1:0] wbs0_dat_i;output [(bytesel_width-1):0] wbs0_sel_i;output wbs0_stb_i;output wbs0_we_i;input wbs0_ack_o;input wbs0_err_o;input wbs0_rty_o;input [dw-1:0] wbs0_dat_o;

`ifdef WBS1
   output [aw-1:0] wbs1_adr_i;output [1:0] wbs1_bte_i;output [2:0]	wbs1_cti_i;output wbs1_cyc_i;output [dw-1:0] wbs1_dat_i;output [(bytesel_width-1):0] wbs1_sel_i;output wbs1_stb_i;output wbs1_we_i;input wbs1_ack_o;input wbs1_err_o;input wbs1_rty_o;input [dw-1:0] wbs1_dat_o;
`endif
`ifdef WBS2
   output [aw-1:0] wbs2_adr_i;output [1:0] wbs2_bte_i;output [2:0]	wbs2_cti_i;output wbs2_cyc_i;output [dw-1:0] wbs2_dat_i;output [(bytesel_width-1):0] wbs2_sel_i;output wbs2_stb_i;output wbs2_we_i;input wbs2_ack_o;input wbs2_err_o;input wbs2_rty_o;input [dw-1:0] wbs2_dat_o;
`endif
`ifdef WBS3
   output [aw-1:0] wbs3_adr_i;output [1:0] wbs3_bte_i;output [2:0]	wbs3_cti_i;output wbs3_cyc_i;output [dw-1:0] wbs3_dat_i;output [(bytesel_width-1):0] wbs3_sel_i;output wbs3_stb_i;output wbs3_we_i;input wbs3_ack_o;input wbs3_err_o;input wbs3_rty_o;input [dw-1:0] wbs3_dat_o;
`endif
`ifdef WBS4
   output [aw-1:0] wbs4_adr_i;output [1:0] wbs4_bte_i;output [2:0]	wbs4_cti_i;output wbs4_cyc_i;output [dw-1:0] wbs4_dat_i;output [(bytesel_width-1):0] wbs4_sel_i;output wbs4_stb_i;output wbs4_we_i;input wbs4_ack_o;input wbs4_err_o;input wbs4_rty_o;input [dw-1:0] wbs4_dat_o;
`endif
`ifdef WBS5
   output [aw-1:0] wbs5_adr_i;output [1:0] wbs5_bte_i;output [2:0]	wbs5_cti_i;output wbs5_cyc_i;output [dw-1:0] wbs5_dat_i;output [(bytesel_width-1):0] wbs5_sel_i;output wbs5_stb_i;output wbs5_we_i;input wbs5_ack_o;input wbs5_err_o;input wbs5_rty_o;input [dw-1:0] wbs5_dat_o;
`endif
`ifdef WBS6
   output [aw-1:0] wbs6_adr_i;output [1:0] wbs6_bte_i;output [2:0]	wbs6_cti_i;output wbs6_cyc_i;output [dw-1:0] wbs6_dat_i;output [(bytesel_width-1):0] wbs6_sel_i;output wbs6_stb_i;output wbs6_we_i;input wbs6_ack_o;input wbs6_err_o;input wbs6_rty_o;input [dw-1:0] wbs6_dat_o;
`endif
`ifdef WBS7
   output [aw-1:0] wbs7_adr_i;output [1:0] wbs7_bte_i;output [2:0]	wbs7_cti_i;output wbs7_cyc_i;output [dw-1:0] wbs7_dat_i;output [(bytesel_width-1):0] wbs7_sel_i;output wbs7_stb_i;output wbs7_we_i;input wbs7_ack_o;input wbs7_err_o;input wbs7_rty_o;input [dw-1:0] wbs7_dat_o;
`endif
   ...
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs0_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs0_master_sel_new;
`ifdef WBS1
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs1_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs1_master_sel_new;
`endif
`ifdef WBS2
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs2_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs2_master_sel_new;
`endif
`ifdef WBS3
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs3_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs3_master_sel_new;   
`endif
`ifdef WBS4
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs4_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs4_master_sel_new;   
`endif
`ifdef WBS5
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs5_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs5_master_sel_new;   
`endif
`ifdef WBS6
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs6_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs6_master_sel_new;   
`endif
`ifdef WBS7
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_MASTERS-1:0] wbs7_master_sel;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbs7_master_sel_new;   
`endif

   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_SLAVES-1:0]  wbm0_slave_sel;
`ifdef WBM1   
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_SLAVES-1:0]  wbm1_slave_sel;
`endif
`ifdef WBM2
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_SLAVES-1:0]  wbm2_slave_sel;
`endif
`ifdef WBM3   
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_SLAVES-1:0]  wbm3_slave_sel;
`endif
`ifdef WBM4
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_SLAVES-1:0]  wbm4_slave_sel;
`endif
`ifdef WBM5
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire [`NUM_SLAVES-1:0]  wbm5_slave_sel;
`endif
   ...
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel0
     (
      // Outputs
...
`ifdef WBS1
   ...
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel1
     (
      // Outputs
...
`ifdef WBS2
   // Slave selec logic, for each master   
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel2
     (
      // Outputs
...
`ifdef WBS3
   // Slave selec logic, for each master   
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel3
     (
      // Outputs
...
`ifdef WBS4
   // Slave selec logic, for each master   
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel4
     (
      // Outputs
...
`ifdef WBS5
   // Slave selec logic, for each master   
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel5
     (
      // Outputs
...
`ifdef WBS6
   // Slave selec logic, for each master   
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel6
     (
      // Outputs
...
`ifdef WBS7
   // Slave selec logic, for each master   
   `current_wb_b3_switch_slave_sel_name #(.dw(dw),.aw(aw))  slave_sel7
     (
      // Outputs
...
`endif //  `ifdef WBS7
   ...
   /////////////////////////////////////////////////////////////////////////////
   `current_wb_b3_switch_master_detect_slave_sel master_detect_slave0
     (
      // Outputs
...
`ifdef WBM1
   `current_wb_b3_switch_master_detect_slave_sel master_detect_slave1
     (
      // Outputs
...
`ifdef WBM2
      `current_wb_b3_switch_master_detect_slave_sel master_detect_slave2
     (
      // Outputs
...
`ifdef WBM3
      `current_wb_b3_switch_master_detect_slave_sel master_detect_slave3
     (
      // Outputs
...
`ifdef WBM4
      `current_wb_b3_switch_master_detect_slave_sel master_detect_slave4
     (
      // Outputs
...
`ifdef WBM5
      `current_wb_b3_switch_master_detect_slave_sel master_detect_slave5
     (
      // Outputs
...
`endif //  `ifdef WBM5
   ...
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave0_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux0
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs0_sel_i[(bytesel_width-1):0]),
      ...
      .wbm0_sel_o			(wbm0_sel_o[(bytesel_width-1):0]),
...
`ifdef WBM1      
      ...
      .wbm1_sel_o			(wbm1_sel_o[(bytesel_width-1):0]),
...
`ifdef WBM2      
      ...
      .wbm2_sel_o			(wbm2_sel_o[(bytesel_width-1):0]),
...
`ifdef WBM3      
      ...
      .wbm3_sel_o			(wbm3_sel_o[(bytesel_width-1):0]),
...
`ifdef WBM4      
      ...
      .wbm4_sel_o			(wbm4_sel_o[(bytesel_width-1):0]),
...
`ifdef WBM5      
      ...
      .wbm5_sel_o			(wbm5_sel_o[(bytesel_width-1):0]),
...
`ifdef WBS1
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave1_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux1
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs1_sel_i[(bytesel_width-1):0]),
...
`ifdef WBS2
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave3_sel_width),.crop_output_addresses(crop_output_addresses)) slave_out_mux2
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs2_sel_i[(bytesel_width-1):0]),
...
`ifdef WBS3
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave3_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux3
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs3_sel_i[(bytesel_width-1):0]),
...
`endif //  `ifdef WBS3
`ifdef WBS4
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw), .slave_sel_bit_width(slave4_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux4
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs4_sel_i[(bytesel_width-1):0]),
...
`endif //  `ifdef WBS4
`ifdef WBS5
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw), .slave_sel_bit_width(slave5_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux5
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs5_sel_i[(bytesel_width-1):0]),
...
`endif //  `ifdef WBS5
`ifdef WBS6
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave6_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux6
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs6_sel_i[(bytesel_width-1):0]),
...
`endif //  `ifdef WBS6
`ifdef WBS7
   `current_wb_b3_switch_slave_out_mux #(.dw(dw),.aw(aw),.slave_sel_bit_width(slave7_sel_width),.crop_output_addresses(crop_output_addresses))  slave_out_mux7
     (
      // Outputs
      ...
      .wbs_sel_i			(wbs7_sel_i[(bytesel_width-1):0]),
...
`endif //  `ifdef WBS7
   ...
   `current_wb_b3_switch_master_out_mux 
	#(.watchdog_timer_width(watchdog_timer_width),.aw(aw),.dw(dw))
	master_out_mux0
     (
...
module `current_wb_b3_switch_slave_sel_name
  (
...
`endif
   ...
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE  output reg [num_masters - 1:0] wbs_master_sel;
   output 			  wbs_master_sel_new;

   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg [num_masters - 1:0] 	  wbs_master_sel_r;

   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg [num_masters - 1:0] 	  last_master;

   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm0_req;
	// REMOVE DEBUG CODE
/*
	(* keep = 1, preserve = 1 *) logic [aw-1:(aw-(slave_sel_bit_width))] WB_ADDR_COMPARE; 
	(* keep = 1, preserve = 1 *) logic [aw-1:(aw-(slave_sel_bit_width))] CTRL_ADDR_COMPARE; 
	always @(posedge wb_clk)
		begin
		WB_ADDR_COMPARE <= wbm0_adr_o[aw-1:(aw-(slave_sel_bit_width))];
		CTRL_ADDR_COMPARE <= slave_addr;
		end
...
*/
   assign wbm0_req = (wbm0_adr_o[aw-1:(aw-(slave_sel_bit_width))] ==  slave_addr) &
		     wbm0_cyc_o;
`ifdef WBM1
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm1_req;
   assign wbm1_req = (wbm1_adr_o[aw-1:(aw-(slave_sel_bit_width))] ==  slave_addr) &
		     wbm1_cyc_o;
`endif
   
`ifdef WBM2
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm2_req;
   assign wbm2_req = (wbm2_adr_o[aw-1:(aw-(slave_sel_bit_width))] ==  slave_addr) &
		     wbm2_cyc_o;
`endif

`ifdef WBM3
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm3_req;
   assign wbm3_req = (wbm3_adr_o[aw-1:(aw-(slave_sel_bit_width))] ==  slave_addr) &
		     wbm3_cyc_o;
`endif
`ifdef WBM4
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm4_req;
   assign wbm4_req = (wbm4_adr_o[aw-1:(aw-(slave_sel_bit_width))] ==  slave_addr) &
		     wbm4_cyc_o;
`endif
`ifdef WBM5
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm5_req;
...
`ifdef WBM5
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm0_other_reqs;
   assign wbm0_other_reqs = (wbm1_req | wbm2_req | wbm3_req | wbm4_req | wbm5_req);
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm1_other_reqs;
   assign wbm1_other_reqs = (wbm0_req | wbm2_req | wbm3_req | wbm4_req | wbm5_req);
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm2_other_reqs;
   assign wbm2_other_reqs = (wbm1_req | wbm0_req | wbm3_req | wbm4_req | wbm5_req);
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm3_other_reqs;
   assign wbm3_other_reqs = (wbm1_req | wbm2_req | wbm0_req | wbm4_req | wbm5_req);
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm4_other_reqs;
   assign wbm4_other_reqs = (wbm1_req | wbm2_req | wbm0_req | wbm3_req | wbm5_req);
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 			  wbm5_other_reqs;
...
endmodule // `current_wb_b3_switch_slave_sel_name
...
module `current_wb_b3_switch_master_detect_slave_sel
  (   
    `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE  output reg [`NUM_SLAVES-1:0] wbm_slave_sel,
...
endmodule // `current_wb_b3_switch_master_detect_slave_sel

// All signals FROM master coming in, Muxing them to the signals TO the slave
module `current_wb_b3_switch_slave_out_mux
  (
   // Master ports
   wbm0_adr_o, wbm0_bte_o, wbm0_cti_o, wbm0_cyc_o, wbm0_dat_o, wbm0_sel_o,
...
`endif
   ...
   parameter slave_sel_bit_width = 0;
   parameter crop_output_addresses = 0;
   
   input [aw-1:0] wbm0_adr_o;input [1:0] wbm0_bte_o;input [2:0]	wbm0_cti_o;input wbm0_cyc_o;input [dw-1:0] wbm0_dat_o;input [(bytesel_width-1):0] wbm0_sel_o;input wbm0_stb_o;input wbm0_we_o;
`ifdef WBM1
   input [aw-1:0] wbm1_adr_o;input [1:0] wbm1_bte_o;input [2:0]	wbm1_cti_o;input wbm1_cyc_o;input [dw-1:0] wbm1_dat_o;input [(bytesel_width-1):0] wbm1_sel_o;input wbm1_stb_o;input wbm1_we_o;
`endif
`ifdef WBM2
   input [aw-1:0] wbm2_adr_o;input [1:0] wbm2_bte_o;input [2:0]	wbm2_cti_o;input wbm2_cyc_o;input [dw-1:0] wbm2_dat_o;input [(bytesel_width-1):0] wbm2_sel_o;input wbm2_stb_o;input wbm2_we_o;
`endif
`ifdef WBM3
   input [aw-1:0] wbm3_adr_o;input [1:0] wbm3_bte_o;input [2:0]	wbm3_cti_o;input wbm3_cyc_o;input [dw-1:0] wbm3_dat_o;input [(bytesel_width-1):0] wbm3_sel_o;input wbm3_stb_o;input wbm3_we_o;
`endif
`ifdef WBM4
   input [aw-1:0] wbm4_adr_o;input [1:0] wbm4_bte_o;input [2:0]	wbm4_cti_o;input wbm4_cyc_o;input [dw-1:0] wbm4_dat_o;input [(bytesel_width-1):0] wbm4_sel_o;input wbm4_stb_o;input wbm4_we_o;
`endif
`ifdef WBM5
   input [aw-1:0] wbm5_adr_o;input [1:0] wbm5_bte_o;input [2:0]	wbm5_cti_o;input wbm5_cyc_o;input [dw-1:0] wbm5_dat_o;input [(bytesel_width-1):0] wbm5_sel_o;input wbm5_stb_o;input wbm5_we_o;
`endif
   
   output [aw-1:0] wbs_adr_i;output [1:0] wbs_bte_i;output [2:0] wbs_cti_i;output wbs_cyc_i;output [dw-1:0] wbs_dat_i;output [(bytesel_width-1):0] wbs_sel_i;output wbs_stb_i;output wbs_we_i;

   input [num_masters-1:0] wbs_master_sel;

   input 		   wb_clk, wb_rst;

   wire [aw-1:0] wbs_adr_i_raw;
   assign wbs_adr_i_raw = (wbs_master_sel[0]) ? wbm0_adr_o :
`ifdef WBM1
...
`endif
			   ...
			   assign wbs_adr_i = crop_output_addresses ?  ({{(slave_sel_bit_width){1'b0}},{(aw-slave_sel_bit_width){1'b1}}} & wbs_adr_i_raw): wbs_adr_i_raw;
...
`endif
		       0;
endmodule // `current_wb_b3_switch_slave_out_mux

   
module `current_wb_b3_switch_master_out_mux
  (
...
generate
    if (WATCHDOG_TIMER)
	begin
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg [watchdog_timer_width-1:0] watchdog_timer;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg 			   watchdog_err;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg 			   wbm_stb_r, wbm_stb_r2; // Register strobe
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   wbm_stb_edge; // Detect its edge
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg 			   wbm_stb_edge_r;
   `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE reg 			   wbm_ack_i_r;
   ...
   begin
       `WISHBONE_BRIDGE_MULTIPLE_MASTERS_MULTIPLE_SLAVES_PRESERVE wire 		   watchdog_err;
...
endmodule // `current_wb_b3_switch_master_out_mux
