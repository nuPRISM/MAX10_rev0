...
---========================= Start Description ========================---
--==                                                                  ==--
--== This module overlays a set of coloured blocks on the incomming   ==--
--== video stream to form a chequered pattern. The source is based on ==--
--== colour_bars.vhd and just adds an extra twist.                    ==--
--==                                                                  ==--
---========================== End Description =========================---
...
ARCHITECTURE rtl OF colour_blocks IS

---=========================---
--== Constant Declarations ==--
---=========================---

SIGNAL last_line : STD_LOGIC_VECTOR(5 DOWNTO 0);
...
SIGNAL line_count : STD_LOGIC_VECTOR(5 DOWNTO 0);
SIGNAL start_bar  : STD_LOGIC_VECTOR(2 DOWNTO 0);
...
BEGIN
  ...
  G0 : IF pal GENERATE
    last_line <= CONV_STD_LOGIC_VECTOR(35,6);
  END GENERATE G0;

  G1 : IF NOT(pal) GENERATE
    last_line <= CONV_STD_LOGIC_VECTOR(29, 6);
  END GENERATE G1;

  ---=================================================---
  --== Keep track of vertical position and start bar ==--
  ---=================================================---
  ...
  ---============================================---
  --== Register outputs and pass pass on inputs ==--
  ---============================================---
