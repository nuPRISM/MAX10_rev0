...
--==                                                                  ==--
--== Filename ..... bouncy_rectangle_top.vhd                          ==--
...
---========================= Start Description ========================---
--==                                                                  ==--
--== Top level wrapper for double bouncy rectangle video overlay.     ==--
--==                                                                  ==--
---========================== End Description =========================---
...
ENTITY bouncy_rectangle_top IS
  PORT(
...
END bouncy_rectangle_top;


ARCHITECTURE rtl OF bouncy_rectangle_top IS
...
CONSTANT XStart_rec1 : NATURAL RANGE 0 TO 1439 := 50;
CONSTANT XEnd_rec1   : NATURAL RANGE 0 TO 1439 := 250;
CONSTANT YStart_rec1 : NATURAL RANGE 0 TO 575 := 200;
CONSTANT YEnd_rec1   : NATURAL RANGE 0 TO 575 := 400;
CONSTANT Col_rec1    : NATURAL RANGE 16 TO 235 := 128;

CONSTANT XStart_rec2 : NATURAL RANGE 0 TO 1439 := 500;
CONSTANT XEnd_rec2   : NATURAL RANGE 0 TO 1439 := 1000;
CONSTANT YStart_rec2 : NATURAL RANGE 0 TO 575 := 50;
CONSTANT YEnd_rec2   : NATURAL RANGE 0 TO 575 := 200;
CONSTANT Col_rec2    : NATURAL RANGE 16 TO 235 := 16;
...
SIGNAL p3_video  : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL p3_fvh    : STD_LOGIC_VECTOR(2 DOWNTO 0);
SIGNAL p3_tof    : STD_LOGIC;
SIGNAL p3_line   : STD_LOGIC_VECTOR(9 DOWNTO 0);
SIGNAL p3_sample : STD_LOGIC_VECTOR(10 DOWNTO 0);
...
BEGIN
  ...
  ---============================================---
  --== Overlay bouncy rectangle on blank screen ==--
  ---============================================---
