// CycloneV_System_mm_traffic_generator_0.v

// This file was auto-generated from altera_avalon_mm_traffic_generator_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.1 190 at 2015.10.20.13:23:40

`timescale 1 ps / 1 ps
module CycloneV_System_mm_traffic_generator_0 #(
		parameter DEVICE_FAMILY                          = "Cyclone V",
		parameter TG_AVL_DATA_WIDTH                      = 8,
		parameter TG_AVL_ADDR_WIDTH                      = 12,
		parameter TG_AVL_WORD_ADDR_WIDTH                 = 12,
		parameter TG_AVL_SIZE_WIDTH                      = 1,
		parameter TG_AVL_BE_WIDTH                        = 1,
		...
		parameter TG_TIMEOUT_COUNTER_WIDTH               = 64,
		parameter TG_MAX_READ_LATENCY                    = 128,
		...
		output wire [7:0]  pnf_per_bit,         //       pnf.pnf_per_bit
		output wire [7:0]  pnf_per_bit_persist, //          .pnf_per_bit_persist
		input  wire        avl_ready,           //       avl.waitrequest_n
		output wire [11:0] avl_addr,            //          .address
		output wire        avl_size,            //          .burstcount
		output wire [7:0]  avl_wdata,           //          .writedata
		input  wire [7:0]  avl_rdata,           //          .readdata
	...
	generate
		...
		if (TG_TIMEOUT_COUNTER_WIDTH != 64)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
