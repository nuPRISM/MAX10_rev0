...
begin
	...
	b_SD_cmd_out 				<= data_to_CMD_line;
	b_SD_dat_out 				<= data_line_out;
	b_SD_dat3_out 				<= '1';
		
	b_SD_cmd_oe         <= CMD_tristate_buffer_enable;
	b_SD_dat_oe         <= data_line_direction;
	b_SD_dat3_oe        <= '0';
