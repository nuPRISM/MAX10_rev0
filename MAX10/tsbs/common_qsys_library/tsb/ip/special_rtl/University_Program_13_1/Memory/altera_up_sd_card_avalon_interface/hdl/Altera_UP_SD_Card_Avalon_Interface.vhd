...
entity Altera_UP_SD_Card_Avalon_Interface is
	...
	(
        ...
        b_SD_cmd_in 				: in std_logic;
		b_SD_dat_in 				: in std_logic;
		b_SD_dat3_in				: in std_logic;
		b_SD_cmd_out                : out std_logic;
		b_SD_dat_out                : out std_logic;
		b_SD_dat3_out               : out std_logic;
		b_SD_cmd_oe                : out std_logic;
		b_SD_dat_oe                : out std_logic;
		b_SD_dat3_oe               : out std_logic;
...
begin
	...
	(
		...
		-- Command interface
	    b_SD_cmd_in 			=> b_SD_cmd_in 	 ,
		b_SD_dat_in 			=> b_SD_dat_in 	 ,
		b_SD_dat3_in			=> b_SD_dat3_in	 ,
		b_SD_cmd_out            => b_SD_cmd_out  ,
		b_SD_dat_out            => b_SD_dat_out  ,
		b_SD_dat3_out           => b_SD_dat3_out ,
		b_SD_cmd_oe             => b_SD_cmd_oe   ,
		b_SD_dat_oe             => b_SD_dat_oe   ,
		b_SD_dat3_oe            => b_SD_dat3_oe  ,
