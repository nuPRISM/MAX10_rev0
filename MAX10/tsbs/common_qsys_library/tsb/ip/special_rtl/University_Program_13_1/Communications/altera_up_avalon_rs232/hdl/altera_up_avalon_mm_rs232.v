...
wire actual_UART_RXD;
reg sync0_UART_RXD, sync1_UART_RXD;

always @(posedge clk)
begin
     sync0_UART_RXD <= UART_RXD;
     sync1_UART_RXD <= sync0_UART_RXD;
end

assign actual_UART_RXD = sync1_UART_RXD;
...
altera_up_rs232_in_deserializer RS232_In_Deserializer (
	...
	.serial_data_in		(actual_UART_RXD),
