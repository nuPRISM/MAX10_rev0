...
// GENERATION: XML
// five_lane_seriallite_custom_phy_megafunction_tx_only.v

// Generated using ACDS version 14.1 190 at 2015.07.06.11:15:53

`timescale 1 ps / 1 ps
module five_lane_seriallite_custom_phy_megafunction_tx_only (
	...
	altera_xcvr_custom #(
		...
		.embedded_reset                        (1),
		.channel_interface                     (0)
	) five_lane_seriallite_custom_phy_megafunction_tx_only_inst (
		...
		.rx_ready                    (),                              //        (terminated)
		.tx_forceelecidle            (5'b00000),                      //        (terminated)
		.tx_bitslipboundaryselect    (25'b0000000000000000000000000), //        (terminated)
		.rx_serial_data              (5'b00000),                      //        (terminated)
		...
		.rx_coreclkin                (5'b00000),                      //        (terminated)
