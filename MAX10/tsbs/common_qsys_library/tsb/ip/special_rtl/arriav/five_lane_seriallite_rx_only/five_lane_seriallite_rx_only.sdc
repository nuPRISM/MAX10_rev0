...
## Generated SDC file "five_lane_seriallite_rx_only.sdc.sdc"
...
# MODULE_NAME = five_lane_seriallite_rx_only
# COMPANY     = Altera Corporation
# WEB         = www.altera.com
#
# FUNCTIONAL_DESCRIPTION :
#    SLITE-II SDC Constraint file. Used by Quartus II TimeQuest.
#    To use this constraint file (assuming the name of this file is five_lane_seriallite_rx_only.sdc ):
#       - create a Quartus II project
#       - copy this constraint file into the project directory
#       - open the project
#       - run this constraint file
#           in the TimeQuest tool:  >open five_lane_seriallite_rx_only.sdc
#           or,
#           enable TimeQuest, and add / five_lane_seriallite_rx_only.sdc to the filelist.
...
#*****************************************************************************************
     ...
     set_false_path -from [get_keepers *five_lane_seriallite_rx_only*lsm_up]
set_false_path -from [get_keepers *five_lane_seriallite_rx_only*reset_d[2]*]
