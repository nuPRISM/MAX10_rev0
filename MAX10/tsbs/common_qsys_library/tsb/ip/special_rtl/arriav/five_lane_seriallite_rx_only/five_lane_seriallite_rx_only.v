...
// ============================================================
// Megafunction Name(s):
// 			five_lane_seriallite_rx_only_slite2_top
// ============================================================
...
module five_lane_seriallite_rx_only (
	...
	five_lane_seriallite_rx_only_slite2_top	five_lane_seriallite_rx_only_slite2_top_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="five_lane_seriallite_rx_only_slite2_top" >
// Retrieval info:   <STATIC_SECTION>
// Retrieval info:    <PRIVATES>
// Retrieval info:     <NAMESPACE name = "parameterization">
// Retrieval info:      <PRIVATE name = "T_CFG_TEST" value="1"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "alt_top" value="five_lane_seriallite_rx_only_sister_slite2_top"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "p_iptb_top" value="five_lane_seriallite_rx_only"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "p_port_type" value="rxonly"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "p_SSYNC" value="1"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "p_SCRAM_ENA" value="0"  type="STRING"  enable="0" />
// Retrieval info:      <PRIVATE name = "p_BROADCAST" value="0"  type="STRING"  enable="0" />
// Retrieval info:      <PRIVATE name = "p_DSCRAM_ENA" value="0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "tx_lane_config" value="1"  type="INTEGER"  enable="0" />
// Retrieval info:      <PRIVATE name = "rx_lane_config" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "p_TX_NUM_LANES" value="0"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "p_RX_NUM_LANES" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "tx_panel" value="0"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "clk_comp_panel" value="0"  type="INTEGER"  enable="0" />
// Retrieval info:      <PRIVATE name = "p_FREQ_TOLERANCE" value="0"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "p_VOD" value="0"  type="STRING"  enable="0" />
// Retrieval info:      <PRIVATE name = "p_VOD_CONFIG" value="CONTROL"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "p_PREEMPH" value="0"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "p_TX_PLL_BW" value="LOW"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "filename" value="five_lane_seriallite_rx_only_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="five_lane_seriallite_rx_only.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="five_lane_seriallite_rx_only_sister_slite2_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
