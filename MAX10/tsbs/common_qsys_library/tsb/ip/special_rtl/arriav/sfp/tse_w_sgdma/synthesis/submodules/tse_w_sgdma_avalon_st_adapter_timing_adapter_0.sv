...
//   output_name:        tse_w_sgdma_avalon_st_adapter_timing_adapter_0
//   in_use_ready:       true
//   out_use_ready:      true
//   in_use_valid:       true
//   out_use_valid:      true
...
module tse_w_sgdma_avalon_st_adapter_timing_adapter_0
(  
 output reg         in_ready,
 input               in_valid,
 ...
 /*AUTOARG*/);
   ...
   //| FIFO
   // ---------------------------------------------------------------------                           
   tse_w_sgdma_avalon_st_adapter_timing_adapter_0_fifo tse_w_sgdma_avalon_st_adapter_timing_adapter_0_fifo 
     ( 
       .clk        (clk),
       .reset_n    (reset_n),
       .in_ready   (),
