...
module tse_w_sgdma_mm_interconnect_1_router_default_decode
  #(
...
module tse_w_sgdma_mm_interconnect_1_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    tse_w_sgdma_mm_interconnect_1_router_default_decode the_default_decode(
