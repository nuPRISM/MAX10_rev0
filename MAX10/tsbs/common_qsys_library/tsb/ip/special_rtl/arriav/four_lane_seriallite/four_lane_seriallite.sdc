...
## Generated SDC file "four_lane_seriallite.sdc.sdc"
...
# MODULE_NAME = four_lane_seriallite
# COMPANY     = Altera Corporation
# WEB         = www.altera.com
#
# FUNCTIONAL_DESCRIPTION :
#    SLITE-II SDC Constraint file. Used by Quartus II TimeQuest.
#    To use this constraint file (assuming the name of this file is four_lane_seriallite.sdc ):
#       - create a Quartus II project
#       - copy this constraint file into the project directory
#       - open the project
#       - run this constraint file
#           in the TimeQuest tool:  >open four_lane_seriallite.sdc
#           or,
#           enable TimeQuest, and add / four_lane_seriallite.sdc to the filelist.
...
#*****************************************************************************************
     ...
     set_false_path -from [get_keepers *four_lane_seriallite*link_up]
set_false_path -from [get_keepers *four_lane_seriallite*reset_d[2]*]
        set_clock_groups -asynchronous -group { *four_lane_seriallite*transmit|clkout } -group { *four_lane_seriallite*receive|clkout }
