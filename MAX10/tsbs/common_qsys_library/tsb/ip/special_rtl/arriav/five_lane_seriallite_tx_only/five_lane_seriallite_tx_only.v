...
// ============================================================
// Megafunction Name(s):
// 			five_lane_seriallite_tx_only_slite2_top
// ============================================================
...
module five_lane_seriallite_tx_only (
	tx_parallel_data_in,
	tx_ctrlenable,
	tx_coreclock,
	txrdp_dav,
	...
	output	[31:0]	tx_parallel_data_in;
	output	[3:0]	tx_ctrlenable;
	output		tx_coreclock;
	output		txrdp_dav;
	input		tx_coreclk;
	...
	input		mreset_n;
	input		txrdp_ena;
	input	[31:0]	txrdp_dat;

	wire signal_wire0 = 1'b0;

	five_lane_seriallite_tx_only_slite2_top	five_lane_seriallite_tx_only_slite2_top_inst(
		.tx_parallel_data_in(tx_parallel_data_in),
		.tx_ctrlenable(tx_ctrlenable),
		.tx_coreclock(tx_coreclock),
		.txrdp_dav(txrdp_dav),
		.tx_coreclk(tx_coreclk),
		.ctrl_tc_enascram(signal_wire0),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="five_lane_seriallite_tx_only_slite2_top" >
// Retrieval info:   <STATIC_SECTION>
// Retrieval info:    <PRIVATES>
// Retrieval info:     <NAMESPACE name = "parameterization">
// Retrieval info:      <PRIVATE name = "T_CFG_TEST" value="1"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "alt_top" value="five_lane_seriallite_tx_only_sister_slite2_top"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "p_iptb_top" value="five_lane_seriallite_tx_only"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "p_port_type" value="txonly"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "p_DSCRAM_ENA" value="0"  type="STRING"  enable="0" />
// Retrieval info:      <PRIVATE name = "tx_lane_config" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "rx_lane_config" value="5"  type="INTEGER"  enable="0" />
// Retrieval info:      <PRIVATE name = "p_TX_NUM_LANES" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "p_RX_NUM_LANES" value="0"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "tx_panel" value="0"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "rx_panel" value="0"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "p_RXEQ" value="0"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "p_RX_PLL_BW" value="NEW_LOW"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "filename" value="five_lane_seriallite_tx_only_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="five_lane_seriallite_tx_only.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="five_lane_seriallite_tx_only_sister_slite2_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
