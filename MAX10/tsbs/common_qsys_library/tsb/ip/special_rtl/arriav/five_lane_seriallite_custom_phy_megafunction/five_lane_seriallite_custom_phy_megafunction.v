// megafunction wizard: %Custom PHY v14.1%
// GENERATION: XML
// five_lane_seriallite_custom_phy_megafunction.v

// Generated using ACDS version 14.1 190 at 2015.07.02.15:58:56

`timescale 1 ps / 1 ps
module five_lane_seriallite_custom_phy_megafunction (
		...
		output wire [4:0]   tx_serial_data,              //              tx_serial_data.export
		input  wire [4:0]   tx_forceelecidle,            //            tx_forceelecidle.export
		output wire [0:0]   pll_locked,                  //                  pll_locked.export
		input  wire [4:0]   rx_serial_data,              //              rx_serial_data.export
		output wire [19:0]  rx_runningdisp,              //              rx_runningdisp.export
		output wire [19:0]  rx_disperr,                  //                  rx_disperr.export
		output wire [19:0]  rx_errdetect,                //                rx_errdetect.export
		output wire [4:0]   rx_is_lockedtoref,           //           rx_is_lockedtoref.export
		output wire [4:0]   rx_is_lockedtodata,          //          rx_is_lockedtodata.export
		output wire [4:0]   rx_signaldetect,             //             rx_signaldetect.export
		output wire [19:0]  rx_patterndetect,            //            rx_patterndetect.export
		output wire [19:0]  rx_syncstatus,               //               rx_syncstatus.export
		output wire [24:0]  rx_bitslipboundaryselectout, // rx_bitslipboundaryselectout.export
		output wire [19:0]  rx_rmfifodatainserted,       //       rx_rmfifodatainserted.export
		output wire [19:0]  rx_rmfifodatadeleted,        //        rx_rmfifodatadeleted.export
		output wire [4:0]   rx_rlv,                      //                      rx_rlv.export
		input  wire [4:0]   tx_coreclkin,                //                tx_coreclkin.export
		input  wire [4:0]   rx_coreclkin,                //                rx_coreclkin.export
		output wire [0:0]   tx_clkout,                   //                   tx_clkout.export
		output wire [4:0]   rx_clkout,                   //                   rx_clkout.export
		input  wire [159:0] tx_parallel_data,            //            tx_parallel_data.export
		input  wire [19:0]  tx_datak,                    //                    tx_datak.export
		output wire [159:0] rx_parallel_data,            //            rx_parallel_data.export
		output wire [19:0]  rx_datak,                    //                    rx_datak.export
		output wire [275:0] reconfig_from_xcvr,          //          reconfig_from_xcvr.reconfig_from_xcvr
		input  wire [419:0] reconfig_to_xcvr             //            reconfig_to_xcvr.reconfig_to_xcvr
	);
	...
	altera_xcvr_custom #(
		...
		.run_length_violation_checking         (10),
		...
		.embedded_reset                        (1),
		.channel_interface                     (0)
	) five_lane_seriallite_custom_phy_megafunction_inst (
		...
		.rx_rmfifodatainserted       (rx_rmfifodatainserted),         //       rx_rmfifodatainserted.export
		.rx_rmfifodatadeleted        (rx_rmfifodatadeleted),          //        rx_rmfifodatadeleted.export
		...
		.tx_bitslipboundaryselect    (25'b0000000000000000000000000), //                 (terminated)
		.rx_enabyteord               (5'b00000),                      //                 (terminated)
		.rx_bitslip                  (5'b00000),                      //                 (terminated)
		.rx_byteordflag              (),                              //                 (terminated)
		.rx_recovered_clk            (),                              //                 (terminated)
		.cdr_ref_clk                 (1'b0),                          //                 (terminated)
		.tx_dispval                  (20'b00000000000000000000),      //                 (terminated)
		.tx_forcedisp                (20'b00000000000000000000),      //                 (terminated)
		.pll_powerdown               (1'b0),                          //                 (terminated)
		.tx_digitalreset             (5'b00000),                      //                 (terminated)
		.tx_analogreset              (5'b00000),                      //                 (terminated)
		.tx_cal_busy                 (),                              //                 (terminated)
		.rx_digitalreset             (5'b00000),                      //                 (terminated)
		.rx_analogreset              (5'b00000),                      //                 (terminated)
		.rx_cal_busy                 (),                              //                 (terminated)
		.ext_pll_clk                 (5'b00000)                       //                 (terminated)
	);
...
//-->
// Retrieval info: <instance entity-name="altera_xcvr_custom_phy" version="14.1" >
...
// Retrieval info: 	<generic name="gui_use_rmfifo_status" value="true" />
