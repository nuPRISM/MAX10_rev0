// altddio_input_1bit_altera_gpio_181_pmulvoy.v
...
`timescale 1 ps / 1 ps
module altddio_input_1bit_altera_gpio_181_pmulvoy (
		input  wire       ck,        //        ck.export
		output wire [0:0] dataout_h, // dataout_h.fragment
		output wire [0:0] dataout_l, // dataout_l.fragment
		input  wire [0:0] datain     //    pad_in.export
	);

	wire  [1:0] core_dout; // port fragment
	...
	altera_gpio #(
		...
		.ck                         (ck),                          //        ck.export
		.dout                       ({core_dout[1],core_dout[0]}), // dataout_h.fragment
		.pad_in                     (datain),                      //    pad_in.export
		.cke                        (1'b1),                        // (terminated)
	...
	assign dataout_h = { core_dout[1] };

	assign dataout_l = { core_dout[0] };
