	tse_w_msgdma_2_ic_mii u0 (
		...
		.sgdma_tx_m_read_address                   (<connected-to-sgdma_tx_m_read_address>),                   //                     sgdma_tx_m_read.address
		.sgdma_tx_m_read_read                      (<connected-to-sgdma_tx_m_read_read>),                      //                                    .read
		.sgdma_tx_m_read_byteenable                (<connected-to-sgdma_tx_m_read_byteenable>),                //                                    .byteenable
		.sgdma_tx_m_read_readdata                  (<connected-to-sgdma_tx_m_read_readdata>),                  //                                    .readdata
		...
		.sgdma_rx_m_write_address                  (<connected-to-sgdma_rx_m_write_address>),                  //                    sgdma_rx_m_write.address
		...
		.sgdma_rx_m_write_waitrequest              (<connected-to-sgdma_rx_m_write_waitrequest>),              //                                    .waitrequest
