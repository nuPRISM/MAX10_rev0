	tse_w_sgdma_simple_2_intercon_reduced_fifos u0 (
		...
		.tse_mac_pcs_ref_clk_clock_connection_clk           (<connected-to-tse_mac_pcs_ref_clk_clock_connection_clk>),           // tse_mac_pcs_ref_clk_clock_connection.clk
		.tse_mac_serdes_control_connection_rx_recovclkout   (<connected-to-tse_mac_serdes_control_connection_rx_recovclkout>),   //    tse_mac_serdes_control_connection.rx_recovclkout
		.tse_mac_serdes_control_connection_reconfig_togxb   (<connected-to-tse_mac_serdes_control_connection_reconfig_togxb>),   //                                     .reconfig_togxb
		.tse_mac_serdes_control_connection_reconfig_fromgxb (<connected-to-tse_mac_serdes_control_connection_reconfig_fromgxb>), //                                     .reconfig_fromgxb
		.tse_mac_serial_connection_rxp                      (<connected-to-tse_mac_serial_connection_rxp>),                      //            tse_mac_serial_connection.rxp
		.tse_mac_serial_connection_txp                      (<connected-to-tse_mac_serial_connection_txp>),                      //                                     .txp
