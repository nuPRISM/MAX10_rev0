...
module tse_w_sgdma_simple_2_ic_red_fifo_tbi (
	...
	tse_mac_serdes_control_connection_sd_loopback,
	tse_mac_serdes_control_connection_powerdown,
	...
	tse_mac_tbi_connection_rx_clk,
	tse_mac_tbi_connection_tx_clk,
	tse_mac_tbi_connection_rx_d,
	tse_mac_tbi_connection_tx_d,
	...
	output		tse_mac_serdes_control_connection_sd_loopback;
	output		tse_mac_serdes_control_connection_powerdown;
	...
	input		tse_mac_tbi_connection_rx_clk;
	input		tse_mac_tbi_connection_tx_clk;
	input	[9:0]	tse_mac_tbi_connection_rx_d;
	output	[9:0]	tse_mac_tbi_connection_tx_d;
