	udp_streamer_subsystem u0 (
		...
		.dc_fifo_1_in_clk_clk                       (<connected-to-dc_fifo_1_in_clk_clk>),                       //             dc_fifo_1_in_clk.clk
		.dc_fifo_2_in_clk_clk                       (<connected-to-dc_fifo_2_in_clk_clk>),                       //             dc_fifo_2_in_clk.clk
		.dc_fifo_3_in_clk_clk                       (<connected-to-dc_fifo_3_in_clk_clk>),                       //             dc_fifo_3_in_clk.clk
		...
		.udp_inserter_1_snk_data                    (<connected-to-udp_inserter_1_snk_data>),                    //           udp_inserter_1_snk.data
		.udp_inserter_1_snk_valid                   (<connected-to-udp_inserter_1_snk_valid>),                   //                             .valid
		.udp_inserter_1_snk_ready                   (<connected-to-udp_inserter_1_snk_ready>),                   //                             .ready
		.udp_inserter_1_snk_startofpacket           (<connected-to-udp_inserter_1_snk_startofpacket>),           //                             .startofpacket
		.udp_inserter_1_snk_endofpacket             (<connected-to-udp_inserter_1_snk_endofpacket>),             //                             .endofpacket
		.udp_inserter_1_snk_empty                   (<connected-to-udp_inserter_1_snk_empty>),                   //                             .empty
		.udp_inserter_2_snk_data                    (<connected-to-udp_inserter_2_snk_data>),                    //           udp_inserter_2_snk.data
		.udp_inserter_2_snk_valid                   (<connected-to-udp_inserter_2_snk_valid>),                   //                             .valid
		.udp_inserter_2_snk_ready                   (<connected-to-udp_inserter_2_snk_ready>),                   //                             .ready
		.udp_inserter_2_snk_startofpacket           (<connected-to-udp_inserter_2_snk_startofpacket>),           //                             .startofpacket
		.udp_inserter_2_snk_endofpacket             (<connected-to-udp_inserter_2_snk_endofpacket>),             //                             .endofpacket
		.udp_inserter_2_snk_empty                   (<connected-to-udp_inserter_2_snk_empty>),                   //                             .empty
		.udp_inserter_3_snk_data                    (<connected-to-udp_inserter_3_snk_data>),                    //           udp_inserter_3_snk.data
		.udp_inserter_3_snk_valid                   (<connected-to-udp_inserter_3_snk_valid>),                   //                             .valid
		.udp_inserter_3_snk_ready                   (<connected-to-udp_inserter_3_snk_ready>),                   //                             .ready
		.udp_inserter_3_snk_startofpacket           (<connected-to-udp_inserter_3_snk_startofpacket>),           //                             .startofpacket
		.udp_inserter_3_snk_endofpacket             (<connected-to-udp_inserter_3_snk_endofpacket>),             //                             .endofpacket
		.udp_inserter_3_snk_empty                   (<connected-to-udp_inserter_3_snk_empty>)                    //                             .empty
	);
