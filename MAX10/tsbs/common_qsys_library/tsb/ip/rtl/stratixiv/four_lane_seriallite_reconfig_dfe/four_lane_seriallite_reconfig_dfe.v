...
//alt2gxb_reconfig BASE_PORT_WIDTH=1 CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" ENABLE_BUF_CAL="TRUE" ENABLE_CHL_ADDR_FOR_ANALOG_CTRL="TRUE" ENABLE_DFE="ON" ENABLE_SELF_RECOVERY="TRUE" NUMBER_OF_CHANNELS=1 NUMBER_OF_RECONFIG_PORTS=1 READ_BASE_PORT_WIDTH=1 RECONFIG_FROMGXB_WIDTH=17 RECONFIG_MODE_SEL_WIDTH=4 RECONFIG_TOGXB_WIDTH=4 busy ctrl_address ctrl_read ctrl_readdata ctrl_waitrequest ctrl_write ctrl_writedata data_valid error read reconfig_clk reconfig_fromgxb reconfig_mode_sel reconfig_reset reconfig_togxb tx_vodctrl tx_vodctrl_out write_all
...
module  four_lane_seriallite_reconfig_dfe_alt_dprio_2vj
	( 
	address,
	busy,
	datain,
...
endmodule //four_lane_seriallite_reconfig_dfe_alt_dprio_2vj
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_dfe_mux_t7a
	( 
	data,
	result,
	sel) ;
...
endmodule //four_lane_seriallite_reconfig_dfe_mux_t7a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_dfe_mux_86a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_dfe_mux_86a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_dfe_mux_p7a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_dfe_mux_p7a

//synthesis_resources = alt_cal 1 alt_dfe 1 lpm_compare 4 lpm_counter 2 lpm_decode 2 lut 47 reg 131 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  four_lane_seriallite_reconfig_dfe_alt2gxb_reconfig_iel1
	( 
	busy,
	ctrl_address,
	ctrl_read,
...
`endif
	...
	wire  [15:0]   wire_dfe_o_avmm_sreaddata;
	wire  wire_dfe_o_avmm_swaitrequest;
	wire  [15:0]   wire_dfe_o_dprio_addr;
	wire  [15:0]   wire_dfe_o_dprio_data;
	wire  wire_dfe_o_dprio_rden;
	wire  wire_dfe_o_dprio_wren;
	wire  [8:0]   wire_dfe_o_quad_address;
	wire  wire_dfe_o_reconfig_busy;
	...
	.i_avmm_saddress((ctrl_address & {16{(~ is_do_eyemon)}})),
	.i_avmm_sread((ctrl_read & (~ is_do_eyemon))),
	.i_avmm_swrite((ctrl_write & (~ is_do_eyemon))),
	.i_avmm_swritedata((ctrl_writedata & {16{(~ is_do_eyemon)}})),
	...
	defparam
		dfe.channel_address_width = 2,
		dfe.ireg_chaddr_width = 2,
		dfe.lpm_type = "alt_dfe";
	four_lane_seriallite_reconfig_dfe_alt_dprio_2vj   dprio
	( 
	...
	four_lane_seriallite_reconfig_dfe_mux_t7a   adce_dprio_addr_mux
	( 
	...
	four_lane_seriallite_reconfig_dfe_mux_t7a   adce_dprio_data_mux
	( 
	.data({eyemon_dprio_data, dfe_dprio_data, adce_dprio_data, a2gr_dprio_data}),
	.result(wire_adce_dprio_data_mux_result),
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_dfe_mux_86a   adce_dprio_enas_mux
	( 
	...
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_dfe_mux_p7a   address_pres_reg_mux
	( 
	...
	assign
		...
		dfe_pres_reg = {wire_dfe_o_quad_address, 1'b0, wire_dfe_o_dprio_addr[13:12]},
		...
		is_diff_mif = 1'b0,
		is_do_dfe = ((((~ reconfig_mode_sel[0]) & (~ reconfig_mode_sel[1])) & reconfig_mode_sel[2]) & reconfig_mode_sel[3]),
		is_do_eyemon = 1'b0,
		...
		read_done = ((read_word_done | (is_illegal_reg_out & read_state)) | reset_system),
...
endmodule //four_lane_seriallite_reconfig_dfe_alt2gxb_reconfig_iel1
//VALID FILE
...
module four_lane_seriallite_reconfig_dfe (
	...
	wire  error = sub_wire4;
	wire [3:0] reconfig_togxb = sub_wire5[3:0];
	wire [2:0] tx_vodctrl_out = sub_wire6[2:0];

	four_lane_seriallite_reconfig_dfe_alt2gxb_reconfig_iel1	four_lane_seriallite_reconfig_dfe_alt2gxb_reconfig_iel1_component (
				...
				.tx_vodctrl_out (sub_wire6))/* synthesis synthesis_clearbox=2
	 clearbox_macroname = alt2gxb_reconfig
	 clearbox_defparam = "base_port_width=1;cbx_blackbox_list=-lpm_mux;enable_chl_addr_for_analog_ctrl=TRUE;enable_dfe=ON;enable_self_recovery=TRUE;intended_device_family=Stratix IV;number_of_channels=1;number_of_reconfig_ports=1;read_base_port_width=1;reconfig_mode_sel_width=4;enable_buf_cal=true;reconfig_fromgxb_width=17;reconfig_togxb_width=4;" */;
