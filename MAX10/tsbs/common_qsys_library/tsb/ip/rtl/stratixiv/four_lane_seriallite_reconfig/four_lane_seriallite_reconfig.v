...
//alt2gxb_reconfig BASE_PORT_WIDTH=1 CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" ENABLE_BUF_CAL="TRUE" ENABLE_CHL_ADDR_FOR_ANALOG_CTRL="TRUE" ENABLE_SELF_RECOVERY="TRUE" NUMBER_OF_CHANNELS=1 NUMBER_OF_RECONFIG_PORTS=1 READ_BASE_PORT_WIDTH=1 RECONFIG_FROMGXB_WIDTH=17 RECONFIG_TOGXB_WIDTH=4 busy data_valid error read reconfig_clk reconfig_fromgxb reconfig_mode_sel reconfig_reset reconfig_togxb tx_vodctrl tx_vodctrl_out write_all
...
module  four_lane_seriallite_reconfig_alt_dprio_2vj
	( 
	address,
	busy,
	datain,
...
endmodule //four_lane_seriallite_reconfig_alt_dprio_2vj

//synthesis_resources = alt_cal 1 lpm_compare 4 lpm_counter 2 lpm_decode 2 lut 1 reg 130 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  four_lane_seriallite_reconfig_alt2gxb_reconfig_tl91
	( 
	busy,
	data_valid,
	error,
...
`endif
	...
	four_lane_seriallite_reconfig_alt_dprio_2vj   dprio
	( 
...
endmodule //four_lane_seriallite_reconfig_alt2gxb_reconfig_tl91
//VALID FILE
...
module four_lane_seriallite_reconfig (
	...
	four_lane_seriallite_reconfig_alt2gxb_reconfig_tl91	four_lane_seriallite_reconfig_alt2gxb_reconfig_tl91_component (
				.read (read),
