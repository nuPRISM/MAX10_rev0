...
// ============================================================
// File Name: four_lane_seriallite_reconfig_eyeq.v
// Megafunction Name(s):
// 			alt2gxb_reconfig
//
...
//alt2gxb_reconfig BASE_PORT_WIDTH=1 CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" ENABLE_BUF_CAL="TRUE" ENABLE_CHL_ADDR_FOR_ANALOG_CTRL="TRUE" ENABLE_EYE_MONITOR="ON" ENABLE_SELF_RECOVERY="TRUE" NUMBER_OF_CHANNELS=1 NUMBER_OF_RECONFIG_PORTS=1 READ_BASE_PORT_WIDTH=1 RECONFIG_FROMGXB_WIDTH=17 RECONFIG_MODE_SEL_WIDTH=4 RECONFIG_TOGXB_WIDTH=4 busy ctrl_address ctrl_read ctrl_readdata ctrl_waitrequest ctrl_write ctrl_writedata error reconfig_clk reconfig_fromgxb reconfig_mode_sel reconfig_reset reconfig_togxb tx_vodctrl write_all
...
module  four_lane_seriallite_reconfig_eyeq_alt_dprio_2vj
	( 
	address,
	busy,
	datain,
...
endmodule //four_lane_seriallite_reconfig_eyeq_alt_dprio_2vj
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_eyeq_mux_t7a
	( 
	data,
	result,
	sel) ;
...
endmodule //four_lane_seriallite_reconfig_eyeq_mux_t7a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_eyeq_mux_86a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_eyeq_mux_86a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_eyeq_mux_p7a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_eyeq_mux_p7a

//synthesis_resources = alt_cal 1 alt_eyemon 1 lpm_compare 4 lpm_counter 2 lpm_decode 2 lut 47 reg 127 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  four_lane_seriallite_reconfig_eyeq_alt2gxb_reconfig_8aj1
	( 
	busy,
	ctrl_address,
	ctrl_read,
...
// synopsys translate_off
`endif
	tri0   [15:0]  ctrl_address;
	tri0   ctrl_read;
	tri0   ctrl_write;
	tri0   [15:0]  ctrl_writedata;
...
`endif
	...
	wire  [15:0]   wire_eyemonitor_o_avmm_sreaddata;
	wire  wire_eyemonitor_o_avmm_swaitrequest;
	wire  [15:0]   wire_eyemonitor_o_dprio_addr;
	wire  [15:0]   wire_eyemonitor_o_dprio_data;
	wire  wire_eyemonitor_o_dprio_rden;
	wire  wire_eyemonitor_o_dprio_wren;
	wire  [8:0]   wire_eyemonitor_o_quad_address;
	wire  wire_eyemonitor_o_reconfig_busy;
	...
	wire  [3:0]  default_max_limit_wire;
	wire  dfe_busy;
	...
	four_lane_seriallite_reconfig_eyeq_alt_dprio_2vj   dprio
	( 
	...
	alt_eyemon   eyemonitor
	( 
	.i_avmm_clk(reconfig_clk),
	.i_avmm_saddress((ctrl_address & {16{(~ is_do_dfe)}})),
	.i_avmm_sread((ctrl_read & (~ is_do_dfe))),
	.i_avmm_swrite((ctrl_write & (~ is_do_dfe))),
	.i_avmm_swritedata((ctrl_writedata & {16{(~ is_do_dfe)}})),
	.i_dprio_busy(wire_dprio_busy),
	.i_dprio_in(wire_dprio_dataout),
	.i_remap_address(address_pres_reg),
	.i_remap_phase(remap_eyemon),
	.i_resetn((~ reconfig_reset_all)),
	...
	defparam
		eyemonitor.channel_address_width = 3,
		eyemonitor.ireg_chaddr_width = 3,
		eyemonitor.lpm_type = "alt_eyemon";
	// synopsys translate_off
	initial
		address_pres_reg = 0;
	// synopsys translate_on
	...
	four_lane_seriallite_reconfig_eyeq_mux_t7a   adce_dprio_addr_mux
	( 
	...
	four_lane_seriallite_reconfig_eyeq_mux_t7a   adce_dprio_data_mux
	( 
	.data({eyemon_dprio_data, dfe_dprio_data, adce_dprio_data, a2gr_dprio_data}),
	.result(wire_adce_dprio_data_mux_result),
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_eyeq_mux_86a   adce_dprio_enas_mux
	( 
	...
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_eyeq_mux_p7a   address_pres_reg_mux
	( 
	...
	assign
		...
		adce_error_wire = 1'b0,
		adce_pres_reg = {12{1'b0}},
		...
		default_max_limit_wire = 4'b1110,
		dfe_busy = 1'b0,
		...
		eyemon_pres_reg = {wire_eyemonitor_o_quad_address, wire_eyemonitor_o_dprio_addr[14:12]},
		...
		is_diff_mif = 1'b0,
		is_do_dfe = 1'b0,
		is_do_eyemon = ((((reconfig_mode_sel[0] & reconfig_mode_sel[1]) & (~ reconfig_mode_sel[2])) & reconfig_mode_sel[3]) | (((reconfig_mode_sel[0] & (~ reconfig_mode_sel[1])) & reconfig_mode_sel[2]) & reconfig_mode_sel[3])),
		...
		remap_eyemon = (((reconfig_mode_sel[0] & (~ reconfig_mode_sel[1])) & reconfig_mode_sel[2]) & reconfig_mode_sel[3]),
		...
		start = 1'b0,
		state_mc_reg_in = {((s0_to_2 | s0_to_1) | ((((~ s2_to_0) & (~ s0_to_1)) & (~ s0_to_0)) & state_mc_reg[1])), (s0_to_2 | ((~ s2_to_0) & state_mc_reg[0]))},
		...
		write_done = (((write_word_done & write_happened) | (is_illegal_reg_out & write_state)) | reset_system),
...
endmodule //four_lane_seriallite_reconfig_eyeq_alt2gxb_reconfig_8aj1
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module four_lane_seriallite_reconfig_eyeq (
	ctrl_address,
	ctrl_read,
	ctrl_write,
	ctrl_writedata,
	...
	wire [3:0] sub_wire4;
	wire  busy = sub_wire0;
	wire [15:0] ctrl_readdata = sub_wire1[15:0];
	wire  ctrl_waitrequest = sub_wire2;
	wire  error = sub_wire3;
	wire [3:0] reconfig_togxb = sub_wire4[3:0];

	four_lane_seriallite_reconfig_eyeq_alt2gxb_reconfig_8aj1	four_lane_seriallite_reconfig_eyeq_alt2gxb_reconfig_8aj1_component (
				...
				.write_all (write_all),
				.busy (sub_wire0),
				.ctrl_readdata (sub_wire1),
				.ctrl_waitrequest (sub_wire2),
				.error (sub_wire3),
				.reconfig_togxb (sub_wire4))/* synthesis synthesis_clearbox=2
	 clearbox_macroname = alt2gxb_reconfig
	 clearbox_defparam = "base_port_width=1;cbx_blackbox_list=-lpm_mux;enable_chl_addr_for_analog_ctrl=TRUE;enable_eye_monitor=ON;enable_self_recovery=TRUE;intended_device_family=Stratix IV;number_of_channels=1;number_of_reconfig_ports=1;read_base_port_width=1;reconfig_mode_sel_width=4;enable_buf_cal=true;reconfig_fromgxb_width=17;reconfig_togxb_width=4;" */;
...
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_eyeq.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_eyeq.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_eyeq.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_eyeq.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_eyeq_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_eyeq_bb.v TRUE
