...
// ============================================================
// File Name: four_lane_seriallite_reconfig_aeq.v
// Megafunction Name(s):
// 			alt2gxb_reconfig
//
...
//alt2gxb_reconfig aeq_fromgxb_width=32 aeq_togxb_width=24 BASE_PORT_WIDTH=1 CBX_AUTO_BLACKBOX="ALL" CHANNEL_ADDRESS_WIDTH=2 DEVICE_FAMILY="Stratix IV" ENABLE_AEQ="ON" ENABLE_BUF_CAL="TRUE" ENABLE_CHL_ADDR_FOR_ANALOG_CTRL="TRUE" ENABLE_SELF_RECOVERY="TRUE" NUMBER_OF_CHANNELS=4 NUMBER_OF_RECONFIG_PORTS=1 READ_BASE_PORT_WIDTH=1 RECONFIG_FROMGXB_WIDTH=17 RECONFIG_MODE_SEL_WIDTH=4 RECONFIG_TOGXB_WIDTH=4 aeq_fromgxb aeq_togxb busy data_valid error logical_channel_address read reconfig_clk reconfig_fromgxb reconfig_mode_sel reconfig_reset reconfig_togxb tx_vodctrl tx_vodctrl_out write_all
//VERSION_BEGIN 14.1 cbx_alt2gxb_reconfig 2015:01:19:16:14:34:SJ cbx_alt_cal 2015:01:19:16:14:34:SJ cbx_alt_dprio 2015:01:19:16:14:34:SJ cbx_altsyncram 2015:01:19:16:14:34:SJ cbx_cycloneii 2015:01:19:16:14:34:SJ cbx_lpm_add_sub 2015:01:19:16:14:34:SJ cbx_lpm_compare 2015:01:19:16:14:34:SJ cbx_lpm_counter 2015:01:19:16:14:34:SJ cbx_lpm_decode 2015:01:19:16:14:34:SJ cbx_lpm_mux 2015:01:19:16:14:34:SJ cbx_lpm_shiftreg 2015:01:19:16:14:34:SJ cbx_mgl 2015:01:19:16:18:34:SJ cbx_stratix 2015:01:19:16:14:35:SJ cbx_stratixii 2015:01:19:16:14:35:SJ cbx_stratixiii 2015:01:19:16:14:35:SJ cbx_stratixv 2015:01:19:16:14:35:SJ cbx_util_mgl 2015:01:19:16:14:35:SJ  VERSION_END
...
//VERSION_BEGIN 14.1 cbx_alt_dprio 2015:01:19:16:14:34:SJ cbx_cycloneii 2015:01:19:16:14:34:SJ cbx_lpm_add_sub 2015:01:19:16:14:34:SJ cbx_lpm_compare 2015:01:19:16:14:34:SJ cbx_lpm_counter 2015:01:19:16:14:34:SJ cbx_lpm_decode 2015:01:19:16:14:34:SJ cbx_lpm_shiftreg 2015:01:19:16:14:34:SJ cbx_mgl 2015:01:19:16:18:34:SJ cbx_stratix 2015:01:19:16:14:35:SJ cbx_stratixii 2015:01:19:16:14:35:SJ  VERSION_END
...
module  four_lane_seriallite_reconfig_aeq_alt_dprio_2vj
	( 
	address,
	busy,
	datain,
...
endmodule //four_lane_seriallite_reconfig_aeq_alt_dprio_2vj


//lpm_mux CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" LPM_SIZE=4 LPM_WIDTH=16 LPM_WIDTHS=2 data result sel
//VERSION_BEGIN 14.1 cbx_lpm_mux 2015:01:19:16:14:34:SJ cbx_mgl 2015:01:19:16:18:34:SJ  VERSION_END

//synthesis_resources = lut 16 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_aeq_mux_t7a
	( 
	data,
	result,
	sel) ;
...
endmodule //four_lane_seriallite_reconfig_aeq_mux_t7a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_aeq_mux_86a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	assign		wire_l1_w0_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[6] : data_wire[4];
	assign		wire_l1_w1_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[3] : data_wire[1];
	assign		wire_l1_w1_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[7] : data_wire[5];
	assign		wire_l2_w0_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[9] : data_wire[8];
	assign		wire_l2_w1_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[11] : data_wire[10];
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_aeq_mux_86a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_aeq_mux_p7a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	wire	wire_l2_w9_n0_mux_dataout;
	wire  [71:0]  data_wire;
	wire  [11:0]  result_wire_ext;
	wire  [3:0]  sel_wire;

	assign		wire_l1_w0_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[12] : data_wire[0];
	assign		wire_l1_w0_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[36] : data_wire[24];
	assign		wire_l1_w10_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[22] : data_wire[10];
	assign		wire_l1_w10_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[46] : data_wire[34];
	assign		wire_l1_w11_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[23] : data_wire[11];
	assign		wire_l1_w11_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[47] : data_wire[35];
	assign		wire_l1_w1_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[13] : data_wire[1];
	assign		wire_l1_w1_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[37] : data_wire[25];
	assign		wire_l1_w2_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[14] : data_wire[2];
	assign		wire_l1_w2_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[38] : data_wire[26];
	assign		wire_l1_w3_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[15] : data_wire[3];
	assign		wire_l1_w3_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[39] : data_wire[27];
	assign		wire_l1_w4_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[16] : data_wire[4];
	assign		wire_l1_w4_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[40] : data_wire[28];
	assign		wire_l1_w5_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[17] : data_wire[5];
	assign		wire_l1_w5_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[41] : data_wire[29];
	assign		wire_l1_w6_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[18] : data_wire[6];
	assign		wire_l1_w6_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[42] : data_wire[30];
	assign		wire_l1_w7_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[19] : data_wire[7];
	assign		wire_l1_w7_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[43] : data_wire[31];
	assign		wire_l1_w8_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[20] : data_wire[8];
	assign		wire_l1_w8_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[44] : data_wire[32];
	assign		wire_l1_w9_n0_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[21] : data_wire[9];
	assign		wire_l1_w9_n1_mux_dataout = (sel_wire[0] === 1'b1) ? data_wire[45] : data_wire[33];
	assign		wire_l2_w0_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[49] : data_wire[48];
	assign		wire_l2_w10_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[69] : data_wire[68];
	assign		wire_l2_w11_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[71] : data_wire[70];
	assign		wire_l2_w1_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[51] : data_wire[50];
	assign		wire_l2_w2_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[53] : data_wire[52];
	assign		wire_l2_w3_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[55] : data_wire[54];
	assign		wire_l2_w4_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[57] : data_wire[56];
	assign		wire_l2_w5_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[59] : data_wire[58];
	assign		wire_l2_w6_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[61] : data_wire[60];
	assign		wire_l2_w7_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[63] : data_wire[62];
	assign		wire_l2_w8_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[65] : data_wire[64];
	assign		wire_l2_w9_n0_mux_dataout = (sel_wire[3] === 1'b1) ? data_wire[67] : data_wire[66];
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_aeq_mux_p7a
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_aeq_mux_76a
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	assign
		...
		sel_wire = {sel[1], {2{1'b0}}, sel[0]};
endmodule //four_lane_seriallite_reconfig_aeq_mux_76a

//synthesis_resources = alt_aeq_s4 1 alt_cal 1 lpm_compare 4 lpm_counter 3 lpm_decode 3 lut 48 reg 131 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  four_lane_seriallite_reconfig_aeq_alt2gxb_reconfig_g1o1
	( 
	adce_cal_busy,
	aeq_fromgxb,
	aeq_togxb,
	...
	input   [31:0]  aeq_fromgxb;
	output   [23:0]  aeq_togxb;
	output   busy;
	output   [3:0]  conv_error;
...
// synopsys translate_off
`endif
	tri0   [31:0]  aeq_fromgxb;
	tri0   [1:0]  logical_channel_address;
	tri0   read;
	tri0   [3:0]  reconfig_mode_sel;
	tri0   reconfig_reset;
	tri0   [2:0]  tx_vodctrl;
	tri0   write_all;
`ifndef ALTERA_RESERVED_QIS
...
`endif
	...
	wire  wire_aeq_s4_adce_cal_busy;
	wire  [3:0]   wire_aeq_s4_adce_standby;
	wire  wire_aeq_s4_busy;
	wire  [3:0]   wire_aeq_s4_conv_error;
	wire  [15:0]   wire_aeq_s4_dprio_addr;
	wire  [15:0]   wire_aeq_s4_dprio_data;
	wire  wire_aeq_s4_dprio_rden;
	wire  wire_aeq_s4_dprio_wren;
	wire  [3:0]   wire_aeq_s4_eqout;
	wire  [3:0]   wire_aeq_s4_error;
	wire  [8:0]   wire_aeq_s4_quad_address;
	wire  [15:0]   wire_aeq_s4_testbus_sels;
	wire  wire_aeq_s4_timeout;
	...
	reg	is_illegal_reg;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[3:0]	reconf_mode_sel_reg;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	reset_system_reg;
	wire	wire_reset_system_reg_sclr;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	...
	wire  wire_max_oper_limit_aeb;
	wire  [1:0]   wire_addr_cntr_q;
	wire  [5:0]   wire_oper_count_q;
	wire  [3:0]   wire_chl_addr_decode_eq;
	wire  [15:0]   wire_reconf_mode_dec_eq;
	wire  [15:0]   wire_adce_dprio_addr_mux_result;
	wire  [15:0]   wire_adce_dprio_data_mux_result;
	wire  [1:0]   wire_adce_dprio_enas_mux_result;
	wire  [11:0]   wire_address_pres_reg_mux_result;
	...
	wire  [15:0]  adce_dprio_addr_s4;
	wire  [15:0]  adce_dprio_data;
	wire  adce_dprio_rden;
	wire  adce_dprio_wren;
	wire  adce_error_wire;
	wire  [11:0]  adce_pres_reg;
	wire  adce_state;
	...
	wire  [5:0]  default_max_limit_wire;
	wire  dfe_busy;
	wire  [15:0]  dfe_dprio_addr;
	wire  [15:0]  dfe_dprio_data;
	wire  dfe_dprio_rden;
	wire  dfe_dprio_wren;
	wire  [11:0]  dfe_pres_reg;
	wire  [15:0]  dfe_readdata;
	wire  dfe_swaitrequest;
	...
	wire  eyemon_busy;
	wire  [15:0]  eyemon_dprio_addr;
	wire  [15:0]  eyemon_dprio_data;
	wire  eyemon_dprio_rden;
	wire  eyemon_dprio_wren;
	wire  [11:0]  eyemon_pres_reg;
	wire  [15:0]  eyemon_readdata;
	wire  eyemon_swaitrequest;
	wire  header_proc;
	wire  idle_state;
	...
	wire  read_done;
	wire  read_state;
	wire  read_word_60_63_data_valid;
	wire  read_word_done;
	...
	alt_aeq_s4   aeq_s4
	( 
	.aclr(reconfig_reset_all),
	.adce_cal_busy(wire_aeq_s4_adce_cal_busy),
	.adce_continuous(is_adce_continuous_single_control),
	.adce_done({aeq_fromgxb[31], aeq_fromgxb[23], aeq_fromgxb[15], aeq_fromgxb[7]}),
	.adce_standby(wire_aeq_s4_adce_standby),
	.all_channels(1'b0),
	.busy(wire_aeq_s4_busy),
	.calibrate((write_all & (is_adce_continuous_single_control | is_adce_one_time_single_control))),
	.conv_error(wire_aeq_s4_conv_error),
	.dprio_addr(wire_aeq_s4_dprio_addr),
	.dprio_busy(wire_dprio_busy),
	.dprio_data(wire_aeq_s4_dprio_data),
	.dprio_in(wire_dprio_dataout),
	.dprio_rden(wire_aeq_s4_dprio_rden),
	.dprio_wren(wire_aeq_s4_dprio_wren),
	.eqout(wire_aeq_s4_eqout),
	.error(wire_aeq_s4_error),
	.logical_channel_address(logical_channel_address),
	.quad_address(wire_aeq_s4_quad_address),
	.reconfig_clk(reconfig_clk),
	.remap_address(address_pres_reg),
	.shutdown((write_all & is_adce_standby_single_control)),
	.testbus_sels(wire_aeq_s4_testbus_sels),
	.testbuses({aeq_fromgxb[30:24], aeq_fromgxb[22:16], aeq_fromgxb[14:8], aeq_fromgxb[6:0]}),
	.timeout(wire_aeq_s4_timeout));
	defparam
		aeq_s4.channel_address_width = 2,
		aeq_s4.number_of_channels = 4,
		aeq_s4.show_errors = "NO",
		aeq_s4.lpm_type = "alt_aeq_s4";
	alt_cal   calibration
	( 
	...
	four_lane_seriallite_reconfig_aeq_alt_dprio_2vj   dprio
	( 
	.address((({16{wire_calibration_busy}} & cal_dprio_address) | ({16{(~ wire_calibration_busy)}} & wire_adce_dprio_addr_mux_result))),
	.busy(wire_dprio_busy),
	.datain((({16{wire_calibration_busy}} & wire_calibration_dprio_dataout) | ({16{(~ wire_calibration_busy)}} & wire_adce_dprio_data_mux_result))),
	...
	.rden(((wire_calibration_busy & wire_calibration_dprio_rden) | ((~ wire_calibration_busy) & wire_adce_dprio_enas_mux_result[0]))),
	.reset(reconfig_reset_all),
	.wren(((wire_calibration_busy & wire_calibration_dprio_wren) | ((~ wire_calibration_busy) & wire_adce_dprio_enas_mux_result[1]))),
	...
	always @ ( posedge reconfig_clk or  posedge reconfig_reset_all)
		...
		else  address_pres_reg <= (({12{cal_busy}} & {cal_quad_address, cal_channel_address[2:0]}) | ({12{(~ cal_busy)}} & wire_address_pres_reg_mux_result));
	// synopsys translate_off
	initial
		data_valid_reg = 0;
	// synopsys translate_on
	...
	always @ ( posedge reconfig_clk or  posedge reconfig_reset_all)
		...
		else  error_reg <= ((is_illegal_reg | reset_system) | adce_error_wire);
	// synopsys translate_off
	initial
		is_illegal_reg = 0;
	// synopsys translate_on
	always @ ( posedge reconfig_clk or  posedge reconfig_reset_all)
		...
		else  is_illegal_reg <= reset_system;
	// synopsys translate_off
	initial
		reconf_mode_sel_reg = 0;
	// synopsys translate_on
	always @ ( posedge reconfig_clk or  posedge reconfig_reset_all)
		if (reconfig_reset_all == 1'b1) reconf_mode_sel_reg <= 4'b0;
	...
	// synopsys translate_on
	always @ ( posedge reconfig_clk or  posedge reconfig_reset_all)
		if (reconfig_reset_all == 1'b1) reset_system_reg <= 1'b0;
		else
			if (wire_reset_system_reg_sclr == 1'b1) reset_system_reg <= 1'b0;
			else  reset_system_reg <= ((wire_max_oper_limit_aeb & (~ idle_state)) & (~ is_adce));
	assign
		wire_reset_system_reg_sclr = ((mif_reconfig_done | reset_addr_done) | is_illegal_reg_out);
	// synopsys translate_off
	initial
		state_mc_reg = 2'b00;
	// synopsys translate_on
	...
	defparam
		max_oper_limit.lpm_width = 6,
		max_oper_limit.lpm_type = "lpm_compare";
	...
	.eq(),
	.q(wire_oper_count_q),
	.sclr((idle_state | reconfig_reset_all))
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	,
	...
	defparam
		oper_count.lpm_port_updown = "PORT_UNUSED",
		oper_count.lpm_width = 6,
		oper_count.lpm_type = "lpm_counter";
	...
	defparam
		reconf_mode_dec.lpm_decodes = 16,
		reconf_mode_dec.lpm_width = 4,
		reconf_mode_dec.lpm_type = "lpm_decode";
	four_lane_seriallite_reconfig_aeq_mux_t7a   adce_dprio_addr_mux
	( 
	.data({{eyemon_dprio_addr[15], address_pres_reg[2], channel_address_out, eyemon_dprio_addr[11:0]}, {dfe_dprio_addr[15:14], channel_address_out, dfe_dprio_addr[11:0]}, {adce_dprio_addr_s4[15:14], channel_address_out, adce_dprio_addr_s4[11:0]}, a2gr_dprio_addr}),
	.result(wire_adce_dprio_addr_mux_result),
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_aeq_mux_t7a   adce_dprio_data_mux
	( 
	.data({eyemon_dprio_data, dfe_dprio_data, adce_dprio_data, a2gr_dprio_data}),
	.result(wire_adce_dprio_data_mux_result),
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_aeq_mux_86a   adce_dprio_enas_mux
	( 
	.data({eyemon_dprio_wren, eyemon_dprio_rden, dfe_dprio_wren, dfe_dprio_rden, adce_dprio_wren, adce_dprio_rden, a2gr_dprio_wren, a2gr_dprio_rden}),
	.result(wire_adce_dprio_enas_mux_result),
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_aeq_mux_p7a   address_pres_reg_mux
	( 
	.data({{eyemon_pres_reg[11:0]}, {dfe_pres_reg[11:0]}, {adce_pres_reg[11:0]}, {quad_address, ((is_pll_address | is_central_pcs) | is_bonded_global_clk_div), ((((channel_address[1] | is_bonded_global_clk_div) & (~ is_pll_address)) | ((logical_pll_sel_num[1] | (is_table_59 & is_bonded_reconfig)) & is_pll_address)) | is_central_pcs), (((((channel_address[0] | is_bonded_global_clk_div) & (~ is_pll_address)) | ((logical_pll_sel_num[0] | (is_table_59 & is_bonded_reconfig)) & is_pll_address)) & (~ is_central_pcs)) | (is_table_61 & is_central_pcs))}}),
	.result(wire_address_pres_reg_mux_result),
	.sel({((~ adce_busy_state) & (is_do_eyemon | is_do_dfe)), (adce_busy_state | is_do_eyemon)}));
	four_lane_seriallite_reconfig_aeq_mux_76a   aeq_ch_done_mux
	( 
	.data(aeq_ch_done),
	...
	assign
		...
		adce_busy_state = wire_aeq_s4_busy,
		adce_cal_busy = wire_aeq_s4_adce_cal_busy,
		adce_dprio_addr_s4 = wire_aeq_s4_dprio_addr,
		adce_dprio_data = wire_aeq_s4_dprio_data,
		adce_dprio_rden = wire_aeq_s4_dprio_rden,
		adce_dprio_wren = wire_aeq_s4_dprio_wren,
		adce_error_wire = ((wire_aeq_s4_error[3] | ((wire_aeq_s4_error[2] | ((wire_aeq_s4_error[1] | (wire_aeq_s4_error[0] | wire_aeq_s4_conv_error[0])) | wire_aeq_s4_conv_error[1])) | wire_aeq_s4_conv_error[2])) | wire_aeq_s4_conv_error[3]),
		adce_pres_reg = {wire_aeq_s4_quad_address, 1'b0, wire_aeq_s4_dprio_addr[13:12]},
		adce_state = (state_mc_reg[0:0] & state_mc_reg[1:1]),
		aeq_ch_done = {4{1'b0}},
		aeq_togxb = {wire_aeq_s4_adce_standby[3], 1'b1, (({4{wire_calibration_busy}} & testbus_sels) | ({4{(~ wire_calibration_busy)}} & wire_aeq_s4_testbus_sels[15:12])), wire_aeq_s4_adce_standby[2], 1'b1, (({4{wire_calibration_busy}} & testbus_sels) | ({4{(~ wire_calibration_busy)}} & wire_aeq_s4_testbus_sels[11:8])), wire_aeq_s4_adce_standby[1], 1'b1, (({4{wire_calibration_busy}} & testbus_sels) | ({4{(~ wire_calibration_busy)}} & wire_aeq_s4_testbus_sels[7:4])), wire_aeq_s4_adce_standby[0], 1'b1, (({4{wire_calibration_busy}} & testbus_sels) | ({4{(~ wire_calibration_busy)}} & wire_aeq_s4_testbus_sels[3:0]))},
		bonded_skip = 1'b0,
		...
		conv_error = {wire_aeq_s4_conv_error[3:0]},
		ctrl_readdata = (eyemon_readdata | dfe_readdata),
		ctrl_waitrequest = (eyemon_swaitrequest | dfe_swaitrequest),
		data_valid = (data_valid_reg & idle_state),
		default_max_limit_wire = 6'b111000,
		dfe_busy = 1'b0,
		dfe_dprio_addr = {16{1'b0}},
		dfe_pres_reg = {12{1'b0}},
		dfe_readdata = {16{1'b0}},
		dfe_swaitrequest = 1'b0,
		...
		dprio_datain_preemp1t = {wire_dprio_dataout[15:0]},
		...
		en_read_trigger = ((legal_rd_mode_type & (~ rx_reconfig)) | tx_reconfig),
		en_write_trigger = ((legal_wr_mode_type & (~ rx_reconfig)) | tx_reconfig),
		eqout = wire_aeq_s4_eqout,
		error = error_reg,
		eyemon_busy = 1'b0,
		eyemon_dprio_addr = {16{1'b0}},
		eyemon_pres_reg = {12{1'b0}},
		eyemon_readdata = {16{1'b0}},
		eyemon_swaitrequest = 1'b0,
		header_proc = 1'b0,
		...
		is_adce_continuous_single_control = ((((~ reconfig_mode_sel[0]) & (~ reconfig_mode_sel[1])) & (~ reconfig_mode_sel[2])) & reconfig_mode_sel[3]),
		is_adce_one_time_single_control = (((reconfig_mode_sel[0] & (~ reconfig_mode_sel[1])) & (~ reconfig_mode_sel[2])) & reconfig_mode_sel[3]),
		is_adce_single_control = 1'b0,
		is_adce_standby_single_control = ((((~ reconfig_mode_sel[0]) & reconfig_mode_sel[1]) & (~ reconfig_mode_sel[2])) & reconfig_mode_sel[3]),
		...
		legal_rd_mode_type = ((~ reconfig_mode_sel[3]) & ((~ reconfig_mode_sel[2]) & ((~ reconfig_mode_sel[1]) & (~ reconfig_mode_sel[0])))),
		legal_wr_mode_type = (reconfig_mode_sel[3] | ((~ reconfig_mode_sel[3]) & ((reconfig_mode_sel[2] | (((~ reconfig_mode_sel[2]) & reconfig_mode_sel[1]) & (~ reconfig_mode_sel[0]))) | ((~ reconfig_mode_sel[2]) & (~ reconfig_mode_sel[1]))))),
		...
		read_address = {1'b0, address_pres_reg[2], channel_address_out, 2'b10, {6{1'b0}}, {4{1'b0}}},
		...
		read_word_60_63_data_valid = dprio_pulse,
		read_word_done = read_word_60_63_data_valid,
		read_word_vodctrl_data_valid = read_word_60_63_data_valid,
		...
		testbus_sels = 4'b0110,
		timeout = wire_aeq_s4_timeout,
		transceiver_init = 1'b0,
		tx_reconfig = 1'b1,
		tx_vodctrl_out = tx_vodctrl_reg,
		w446w = {quad_address, channel_address},
		...
		write_address = {1'b0, address_pres_reg[2], channel_address_out, 2'b10, {6{1'b0}}, {4{1'b0}}},
		...
		write_word_60_63_data_valid = 1'b1,
		...
		write_word_done = (dprio_pulse & write_word_vodctrl_data_valid),
		write_word_preemp1t_data_valid = 1'b0,
		write_word_preemp1ta_data_valid = 1'b0,
		write_word_preemp1tb_data_valid = 1'b0,
		write_word_vodctrl_data_valid = write_word_60_63_data_valid,
		write_word_vodctrla_data_valid = 1'b0;
endmodule //four_lane_seriallite_reconfig_aeq_alt2gxb_reconfig_g1o1
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module four_lane_seriallite_reconfig_aeq (
	aeq_fromgxb,
	logical_channel_address,
	read,
	reconfig_clk,
	...
	wire [3:0] sub_wire4;
	wire [2:0] sub_wire5;
	wire [23:0] aeq_togxb = sub_wire0[23:0];
	wire  busy = sub_wire1;
	wire  data_valid = sub_wire2;
	wire  error = sub_wire3;
	wire [3:0] reconfig_togxb = sub_wire4[3:0];
	wire [2:0] tx_vodctrl_out = sub_wire5[2:0];

	four_lane_seriallite_reconfig_aeq_alt2gxb_reconfig_g1o1	four_lane_seriallite_reconfig_aeq_alt2gxb_reconfig_g1o1_component (
				...
				.error (sub_wire3),
				.reconfig_togxb (sub_wire4),
				.tx_vodctrl_out (sub_wire5))/* synthesis synthesis_clearbox=2
	 clearbox_macroname = alt2gxb_reconfig
	 clearbox_defparam = "aeq_fromgxb_width=32;aeq_togxb_width=24;base_port_width=1;cbx_blackbox_list=-lpm_mux;channel_address_width=2;enable_aeq=ON;enable_chl_addr_for_analog_ctrl=TRUE;enable_self_recovery=TRUE;intended_device_family=Stratix IV;number_of_channels=4;number_of_reconfig_ports=1;read_base_port_width=1;reconfig_mode_sel_width=4;enable_buf_cal=true;reconfig_fromgxb_width=17;reconfig_togxb_width=4;" */;
...
// ============================================================
// Retrieval info: PRIVATE: ADCE NUMERIC "1"
...
// Retrieval info: CONSTANT: AEQ_FROMGXB_WIDTH NUMERIC "32"
// Retrieval info: CONSTANT: AEQ_TOGXB_WIDTH NUMERIC "24"
...
// Retrieval info: CONSTANT: ENABLE_AEQ STRING "ON"
...
// Retrieval info: USED_PORT: aeq_fromgxb 0 0 32 0 INPUT NODEFVAL "aeq_fromgxb[31..0]"
// Retrieval info: USED_PORT: aeq_togxb 0 0 24 0 OUTPUT NODEFVAL "aeq_togxb[23..0]"
...
// Retrieval info: CONNECT: @aeq_fromgxb 0 0 32 0 aeq_fromgxb 0 0 32 0
...
// Retrieval info: CONNECT: aeq_togxb 0 0 24 0 @aeq_togxb 0 0 24 0
...
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_aeq.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_aeq.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_aeq.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_aeq.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_aeq_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_aeq_bb.v TRUE
