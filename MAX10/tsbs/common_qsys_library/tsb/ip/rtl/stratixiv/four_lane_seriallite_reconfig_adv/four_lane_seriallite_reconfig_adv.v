...
// ============================================================
// File Name: four_lane_seriallite_reconfig_adv.v
// Megafunction Name(s):
// 			alt2gxb_reconfig
//
...
//alt2gxb_reconfig BASE_PORT_WIDTH=1 CBX_AUTO_BLACKBOX="ALL" CHANNEL_ADDRESS_WIDTH=2 DEVICE_FAMILY="Stratix IV" ENABLE_BUF_CAL="TRUE" ENABLE_CHL_ADDR_FOR_ANALOG_CTRL="TRUE" ENABLE_SELF_RECOVERY="TRUE" NUMBER_OF_CHANNELS=4 NUMBER_OF_RECONFIG_PORTS=1 READ_BASE_PORT_WIDTH=1 RECONFIG_FROMGXB_WIDTH=17 RECONFIG_TOGXB_WIDTH=4 busy data_valid error logical_channel_address read reconfig_clk reconfig_fromgxb reconfig_mode_sel reconfig_reset reconfig_togxb tx_vodctrl tx_vodctrl_out write_all
...
module  four_lane_seriallite_reconfig_adv_alt_dprio_2vj
	( 
	address,
	busy,
	datain,
...
endmodule //four_lane_seriallite_reconfig_adv_alt_dprio_2vj
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  four_lane_seriallite_reconfig_adv_mux_76a
	( 
	data,
	result,
	sel) ;
...
endmodule //four_lane_seriallite_reconfig_adv_mux_76a

//synthesis_resources = alt_cal 1 lpm_compare 4 lpm_counter 3 lpm_decode 3 lut 2 reg 130 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  four_lane_seriallite_reconfig_adv_alt2gxb_reconfig_4be1
	( 
	busy,
	data_valid,
	error,
...
`endif
	...
	four_lane_seriallite_reconfig_adv_alt_dprio_2vj   dprio
	( 
	...
	four_lane_seriallite_reconfig_adv_mux_76a   aeq_ch_done_mux
	( 
	.data(aeq_ch_done),
	...
	assign
		...
		w291w = {quad_address, channel_address},
...
endmodule //four_lane_seriallite_reconfig_adv_alt2gxb_reconfig_4be1
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module four_lane_seriallite_reconfig_adv (
	logical_channel_address,
	read,
	reconfig_clk,
	reconfig_fromgxb,
	...
	wire  error = sub_wire2;
	wire [3:0] reconfig_togxb = sub_wire3[3:0];
	wire [2:0] tx_vodctrl_out = sub_wire4[2:0];

	four_lane_seriallite_reconfig_adv_alt2gxb_reconfig_4be1	four_lane_seriallite_reconfig_adv_alt2gxb_reconfig_4be1_component (
				.logical_channel_address (logical_channel_address),
				.read (read),
				.reconfig_clk (reconfig_clk),
				.reconfig_fromgxb (reconfig_fromgxb),
				.reconfig_mode_sel (sub_wire5),
				...
				.tx_vodctrl_out (sub_wire4))/* synthesis synthesis_clearbox=2
	 clearbox_macroname = alt2gxb_reconfig
	 clearbox_defparam = "base_port_width=1;cbx_blackbox_list=-lpm_mux;channel_address_width=2;enable_chl_addr_for_analog_ctrl=TRUE;enable_self_recovery=TRUE;intended_device_family=Stratix IV;number_of_channels=4;number_of_reconfig_ports=1;read_base_port_width=1;enable_buf_cal=true;reconfig_fromgxb_width=17;reconfig_togxb_width=4;" */;
...
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_adv.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_adv.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_adv.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_adv.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_adv_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL four_lane_seriallite_reconfig_adv_bb.v TRUE
