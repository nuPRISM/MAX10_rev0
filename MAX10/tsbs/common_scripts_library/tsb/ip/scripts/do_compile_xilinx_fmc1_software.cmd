...
echo on
echo "Now compiling Stratix Xilinx FMC1 Software Project..."
cd ../../../tsbs/fmc1/tsb/ip/rtl/workspace/standalone_bsp_0
make
cd $SCRIPTS_PWD
...
$CUT_SCRIPTS_PWD/../../../tsbs/fmc1/tsb/ip/exe/fmc_out.bit -bd \
adc_fmc_mcs_ctrl.elf tag microblaze_mcs_v1_3 -o b \
$CUT_SCRIPTS_PWD/../exe/fmc1_download.bit
