...
echo on
echo "Now compiling Stratix Xilinx FMC0 Software Project..."
cd ../../../tsbs/fmc0/tsb/ip/rtl/workspace/standalone_bsp_0
make
cd $SCRIPTS_PWD
cd ../../../tsbs/fmc0/tsb/ip/rtl/workspace/adc_fmc_mcs_ctrl/Debug
make clean
make
...
$CUT_SCRIPTS_PWD/../../../tsbs/fmc0/tsb/ip/exe/fmc_out.bit -bd \
adc_fmc_mcs_ctrl.elf tag microblaze_mcs_v1_3 -o b \
$CUT_SCRIPTS_PWD/../exe/fmc0_download.bit
