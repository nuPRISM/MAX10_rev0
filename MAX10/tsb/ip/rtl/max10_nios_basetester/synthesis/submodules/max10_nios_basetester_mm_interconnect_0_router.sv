...
module max10_nios_basetester_mm_interconnect_0_router_default_decode
  #(
...
module max10_nios_basetester_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    max10_nios_basetester_mm_interconnect_0_router_default_decode the_default_decode(
